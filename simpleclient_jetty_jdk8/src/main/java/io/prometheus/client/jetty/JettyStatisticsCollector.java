...
public class JettyStatisticsCollector extends Collector {
  ...
  public List<MetricFamilySamples> collect() {
    return Arrays.asList(
        ...
        buildCounter("jetty_dispatched_total", "Number of dispatches",
        ...
        buildCounter("jetty_async_requests_total", "Total number of async requests",
        ...
        buildCounter("jetty_async_dispatches_total",
            "Number of requested that have been asynchronously dispatched",
            statisticsHandler.getAsyncDispatches()),
        buildCounter("jetty_expires_total", "Number of async requests requests that have expired",
