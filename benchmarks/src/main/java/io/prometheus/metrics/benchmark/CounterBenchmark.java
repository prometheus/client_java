...
public class CounterBenchmark {
  ...
  io.prometheus.metrics.Counter prometheusSimpleCounter;
  io.prometheus.metrics.Counter.Child prometheusSimpleCounterChild;
  io.prometheus.metrics.Counter prometheusSimpleCounterNoLabels;

  @Setup
  public void setup() {
    prometheusSimpleCounter = io.prometheus.metrics.Counter.build()
      .name("name")
      .help("some description..")
      .labelNames("some", "group").create();
    prometheusSimpleCounterChild = prometheusSimpleCounter.labels("test", "group");

    prometheusSimpleCounterNoLabels = io.prometheus.metrics.Counter.build()
      .name("name")
      .help("some description..")
      .create();
