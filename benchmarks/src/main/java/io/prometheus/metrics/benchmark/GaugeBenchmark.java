...
public class GaugeBenchmark {
  ...
  io.prometheus.metrics.Gauge prometheusSimpleGauge;
  io.prometheus.metrics.Gauge.Child prometheusSimpleGaugeChild;
  io.prometheus.metrics.Gauge prometheusSimpleGaugeNoLabels;

  @Setup
  public void setup() {
    prometheusSimpleGauge = io.prometheus.metrics.Gauge.build()
      .name("name")
      .help("some description..")
      .labelNames("some", "group").create();
    prometheusSimpleGaugeChild = prometheusSimpleGauge.labels("test", "group");

    prometheusSimpleGaugeNoLabels = io.prometheus.metrics.Gauge.build()
      .name("name")
      .help("some description..")
      .create();
