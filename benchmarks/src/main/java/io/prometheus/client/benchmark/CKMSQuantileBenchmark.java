...
public class CKMSQuantileBenchmark {
  ...
  public static class EmptyBenchmarkState {
    ...
    CKMSQuantilesOld ckmsQuantilesOld;
  ...
  @BenchmarkMode({Mode.AverageTime})
  @OutputTimeUnit(TimeUnit.MILLISECONDS)
  public void ckmsQuantileOldInsertBenchmark(Blackhole blackhole, EmptyBenchmarkState state) {
    CKMSQuantilesOld q = new CKMSQuantilesOld(state.quantiles.toArray(new Quantile[] {}));
  ...
  public static class PrefilledBenchmarkState {
    ...
    public void setup() {
      ...
      ckmsQuantilesOld = new CKMSQuantilesOld(quantiles.toArray(new Quantile[] {}));
      for (long l : shuffle) {
        ckmsQuantiles.insert(l);
        ckmsQuantilesOld.insert(l);
      }
  ...
  @BenchmarkMode({Mode.AverageTime})
  @OutputTimeUnit(TimeUnit.NANOSECONDS)
  public void ckmsQuantileOldGetBenchmark(Blackhole blackhole, PrefilledBenchmarkState state) {
    blackhole.consume(state.ckmsQuantilesOld.get(0.95));
  }
