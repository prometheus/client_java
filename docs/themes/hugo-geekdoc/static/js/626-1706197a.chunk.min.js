  ...
  [626],
  {
    1626: function (e, t, s) {
      ...
      const C = (e, t, s, i, a, n) => {
                ...
                : i.description.length > 0
                  ? ((i.shape = c),
                    i.description === l
                      ...
                      : (i.description = [i.description, s.description]))
          ...
          t &&
            "root" !== t.id &&
            (r.l.trace("Setting node ", l, " to be child of its parent ", t.id),
            e.setParent(l, t.id)),
        ...
        V = {
          ...
          draw: async function (e, t, s, o) {
            ...
            let y;
            C(u, void 0, o.db.getRootDocV2(), h, o.db, !0),
              "sandbox" === c && (y = (0, a.Ys)("#i" + t));
            const f =
                "sandbox" === c ? (0, a.Ys)(y.nodes()[0].contentDocument.body) : (0, a.Ys)("body"),
              w = f.select(`[id="${t}"]`),
              x = f.select("#" + t + " g");
            await (0, n.r)(x, u, ["barb"], l, t),
              r.u.insertTitle(w, "statediagramTitleText", p.titleTopMargin, o.db.getDiagramTitle());
