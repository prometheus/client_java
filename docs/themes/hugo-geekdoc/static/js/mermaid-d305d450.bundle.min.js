          ...
          var r = {
              ...
              storeAPI: {
                ...
                namespace: function (t, e, n) {
                  ...
                  var i = t,
                    a = this[i];
                  if (!((a && a.namespace) || (((a = r.Store(this._id, this._area, this._ns + i + n))._delim = n), this[i] || (this[i] = a), e)))
                    for (var o in r.areas) a.area(o, r.areas[o]);
                  return a;
                },
                isFake: function (t) {
                  return (
                    t ? ((this._real = this._area), (this._area = r.storage("fake"))) : !1 === t && (this._area = this._real || this._area),
                ...
                set: function (t, e, n) {
                  ...
                  return null != a && !1 === n
                    ? e
                    : ("function" == typeof n && ((i = n), (n = void 0)), r.set(this._area, this._in(t), r.stringify(e, i), n) || a);
                },
                setAll: function (t, e) {
                  var n, r;
