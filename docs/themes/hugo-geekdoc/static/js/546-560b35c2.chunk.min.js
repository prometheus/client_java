                  ...
                  switch (s) {
                    ...
                    case 23:
                      (r[l] = r[l].trim().replace(/'/g, '"')),
                        n.parseDirective(r[l], "arg_directive");
                      break;
                    case 24:
                ...
                parse: function (t) {
                  ...
                  for (var g, _, f, m, v, b, k, x, S, w = {}; ; ) {
                    if (
                      ...
                      var $;
                      for (v in ((x = []), r[_]))
                        this.terminals_[v] && v > 2 && x.push("'" + this.terminals_[v] + "'");
                      ($ = h.showPosition
                        ? "Parse error on line " +
                          (l + 1) +
                          ":\n" +
                    ...
                    if (f[0] instanceof Array && f.length > 1)
                      throw new Error(
                        "Parse Error: multiple actions possible at state: " + _ + ", token: " + g,
                      );
                    switch (f[0]) {
                      case 1:
                        e.push(g),
                      ...
                      case 2:
                        if (
                          ...
                          d &&
                            (w._$.range = [
                              s[s.length - (b || 1)].range[0],
                              s[s.length - 1].range[1],
                            ]),
                          void 0 !==
                            (m = this.performAction.apply(
                              w,
                              [c, a, l, u.yy, f[1], n, s].concat(o),
                            )))
                        )
                          return m;
                        b &&
        ...
        y = {
          ...
          db: {
            ...
            addSection: (t, e) => {
              (t = (0, n.d)(t, (0, n.c)())),
                void 0 === o[t] &&
                  ((o[t] = e), n.l.debug(`added new section: ${t}, with value: ${e}`));
            },
            getSections: () => o,
            cleanupValue: (t) => (
              ":" === t.substring(0, 1) && (t = t.substring(1).trim()), Number(t.trim())
            ),
            setShowData: (t) => {
              h = t;
            },
          ...
          renderer: {
            draw: (t, e, i, r) => {
              ...
              const a = r.db,
                ...
                u =
                  (null == (l = null == (c = document.getElementById(e)) ? void 0 : c.parentElement)
                    ? void 0
                    : l.offsetWidth) ?? h.useWidth,
                y = (0, n.B)(e);
              ...
              const $ = p
                ...
                .attr(
                  "transform",
                  (t, e) => "translate(216," + (22 * e - (22 * S.domain().length) / 2) + ")",
                );
              $.append("rect")
                .attr("width", 18)
                .attr("height", 18)
