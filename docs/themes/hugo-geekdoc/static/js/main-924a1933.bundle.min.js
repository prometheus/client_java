                  ...
                  var b = (function (t) {
                      ...
                      var e,
                        ...
                        u =
                          ...
                          function () {
                            ...
                            return !(e = t) || ("object" !== y(e) && "function" != typeof e)
                              ? (function (t) {
                      ...
                      function a(t, e) {
                        ...
                        return (
                          ...
                          (n = u.call(this)).resolveOptions(e),
                          n.listenClick(t),
                          n
                        );
                      }
                            ...
                            value: function (t) {
                              var e = t.delegateTarget || t.currentTarget,
                                ...
                                o = (function () {
                                  ...
                                  return c ? d(c, { container: o }) : r ? ("cut" === n ? s(r) : d(r, { container: o })) : void 0;
                                })({
                                  action: n,
                  ...
                  (e.prototype = {
                    ...
                    off: function (t, e) {
                      var n = this.e || (this.e = {}),
                        o = n[t],
                        r = [];
                      if (o && e) for (var c = 0, i = o.length; c < i; c++) o[c].fn !== e && o[c].fn._ !== e && r.push(o[c]);
      ...
      3243: function (t, e, n) {
        ...
        function o(t) {
          ...
          if (null !== o) {
            ...
            e.classList.add("flex", "align-center", "justify-center", "clip", "gdoc-post__codecopy"),
              (e.type = "button"),
              (e.innerHTML =
      ...
      document.addEventListener("DOMContentLoaded", function (n) {
        new e(".clip").on("success", function (t) {
          ...
          e.hasAttribute("data-copy-feedback") &&
            (e.classList.add("gdoc-post__codecopy--success", "gdoc-post__codecopy--out"),
            e.querySelector(".gdoc-icon.copy").classList.add("hidden"),
            e.querySelector(".gdoc-icon.check").classList.remove("hidden"),
            setTimeout(function () {
              e.classList.remove("gdoc-post__codecopy--success", "gdoc-post__codecopy--out"),
                e.querySelector(".gdoc-icon.copy").classList.remove("hidden"),
                e.querySelector(".gdoc-icon.check").classList.add("hidden");
            }, 3e3)),
            t.clearSelection();
        }),
          document.querySelectorAll(".highlight").forEach((e) => t(e));
      });
    })();
})();
