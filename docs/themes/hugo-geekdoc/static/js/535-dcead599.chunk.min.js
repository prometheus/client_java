    ...
    1535: function (t, e, i) {
      ...
      var s = i(9339),
        n = (function () {
          var t = function (t, e, i, s) {
            ...
            $ = [1, 45],
            A = [
              1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 50, 51, 52,
              53, 56, 60,
            ],
            L = [
            ...
            I = [
              1, 4, 5, 7, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 50, 51,
              52, 53, 56, 60,
            ],
            O = [
              4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 50, 51, 52, 53,
              56, 60,
            ],
            N = {
              trace: function () {},
                ...
                switch (n) {
                  ...
                  case 52:
                    (r[a] = r[a].trim().replace(/'/g, '"')),
                      s.parseDirective(r[a], "arg_directive");
                    break;
                  case 53:
              ...
              table: [
                ...
                t(
                  [
                    1, 4, 5, 16, 17, 19, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 50, 51, 52,
                    53, 56, 60,
                  ],
                  r,
                  { 8: 11 },
              ...
              parse: function (t) {
                ...
                for (var d in this.yy)
                  Object.prototype.hasOwnProperty.call(this.yy, d) && (u.yy[d] = this.yy[d]);
                h.setInput(t, u.yy),
                  (u.yy.lexer = h),
                  (u.yy.parser = this),
                ...
                for (var f, g, m, _, S, k, T, b, E, v = {}; ; ) {
                  if (
                    ...
                    var x;
                    for (S in ((b = []), r[g]))
                      this.terminals_[S] && S > 2 && b.push("'" + this.terminals_[S] + "'");
                    (x = h.showPosition
                      ? "Parse error on line " +
                        (a + 1) +
                        ":\n" +
                  ...
                  switch (m[0]) {
                    ...
                    case 2:
                      if (
                        ...
                        void 0 !==
                          (_ = this.performAction.apply(v, [o, c, a, u.yy, m[1], s, n].concat(l))))
                      )
                        return _;
                      k &&
                        ((e = e.slice(0, -1 * k * 2)),
            ...
            R = {
              ...
              conditions: {
                ...
                INITIAL: {
                  rules: [
                    0, 1, 2, 3, 4, 5, 10, 11, 12, 13, 15, 16, 17, 20, 22, 24, 27, 31, 34, 37, 55,
                    59, 70, 71, 72, 73, 74, 75, 76, 78, 79, 80,
                  ],
                  inclusive: !0,
                },
              },
      ...
      const E = (t) => JSON.parse(JSON.stringify(t)),
        v = (t, e, i) => {
          if (e.stmt === c) v(t, e.state1, !0), v(t, e.state2, !1);
            ...
            (e.stmt === a &&
              ("[*]" === e.id
                ? ((e.id = i ? t.id + "_start" : t.id + "_end"), (e.start = i))
                : (e.id = e.id.trim())),
            e.doc)
          ) {
            const t = [];
        ...
        x = function (t, e = l, i = null, n = null, r = null, o = null, a = null, c = null) {
          ...
          void 0 === k.states[h]
            ...
            : (k.states[h].doc || (k.states[h].doc = i),
              k.states[h].type || (k.states[h].type = e)),
            n &&
            ...
            r &&
              ((k.states[h].note = r),
              (k.states[h].note.text = s.e.sanitizeText(k.states[h].note.text, (0, s.c)()))),
            o &&
              (s.l.info("Setting state classes", h, o),
              ("string" == typeof o ? [o] : o).forEach((t) => N(h, t.trim()))),
            a &&
              (s.l.info("Setting state styles", h, a),
              ("string" == typeof a ? [a] : a).forEach((t) => R(h, t.trim()))),
            c &&
              (s.l.info("Setting state styles", h, a),
              ("string" == typeof c ? [c] : c).forEach((t) => w(h, t.trim())));
        },
        D = function (t) {
          (S = { root: { relations: [], states: {}, documents: {} } }),
            (k = S.root),
      ...
      const L = function (t, e, i) {
          if ("object" == typeof t)
            ...
            x(n, r),
              x(o, a),
              k.relations.push({ id1: n, id2: o, title: s.e.sanitizeText(i, (0, s.c)()) });
          }
        },
        I = function (t, e) {
          const i = k.states[t],
        ...
        B = {
          ...
          getRootDocV2: () => (
            v({ id: "root" }, { id: "root", doc: m }, !0), { id: "root", doc: m }
          ),
          extract: (t) => {
            let e;
            (e = t.doc ? t.doc : t),
