      ...
      const p = function (t) {
        ...
        c = {
          draw: function (t, e, a, r) {
            ...
            const f =
                "sandbox" === g ? (0, n.Ys)(h.nodes()[0].contentDocument.body) : (0, n.Ys)("body"),
              u = f.select(`[id='${e}']`);
            var x;
            (x = u)
              .append("defs")
            ...
            r.db.getRelations().forEach(function (t) {
              o.l.info("tjoho" + p(t.id1) + p(t.id2) + JSON.stringify(t)),
                y.setEdge(p(t.id1), p(t.id2), { relation: t }, t.title || "DEFAULT");
            }),
                ...
                void 0 !== t &&
                  ...
                  f
                    ...
                    .attr(
                      "transform",
                      "translate(" +
                        (y.node(t).x - y.node(t).width / 2) +
                        "," +
                        (y.node(t).y - y.node(t).height / 2) +
                        " )",
                    ));
              }),
              y.edges().forEach(function (t) {
                void 0 !== t &&
                  void 0 !== y.edge(t) &&
                  (o.l.debug("Edge " + t.v + " -> " + t.w + ": " + JSON.stringify(y.edge(t))),
                  s.s.drawEdge(u, y.edge(t), y.edge(t).relation, c, r));
              });
        ...
        o = function (t) {
          ...
          if (g > 1 && h > g && h <= t.length) {
            ...
            if (((e = i + d + "(" + (0, n.x)(o.trim()) + ")"), h < t.length)) {
              ...
              "" !== a || i.match(s)
                ? (r = t.substring(h + 1).trim())
                : ((a = l(i)), (r = t.substring(h + 2).trim())),
                "" !== r &&
                  (":" === r.charAt(0) && (r = r.substring(1).trim()),
                  (r = " : " + (0, n.x)(r)),
                  (e += r));
            }
          } else e = i + (0, n.x)(t);
        ...
        p = {
          ...
          drawEdge: function (t, e, a, d, o) {
            ...
            d.arrowMarkerAbsolute &&
              ...
              "none" !== a.relation.type1 &&
                c.attr("marker-start", "url(" + f + "#" + s(a.relation.type1) + "Start)"),
              "none" !== a.relation.type2 &&
                c.attr("marker-end", "url(" + f + "#" + s(a.relation.type2) + "End)");
          ...
          drawNote: function (t, e, a, r) {
            ...
            const p = o.node().getBBox(),
              c = o
                ...
                .attr(
                  "height",
                  p.height + l.length * a.textHeight + a.padding + 0.5 * a.dividerMargin,
                )
                .node()
                .getBBox().width;
            return (
