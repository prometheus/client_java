                ...
                var e = n(771),
                  ...
                  o = function (e, n) {
                    var a = (function (e, t) {
                      for (
                        ...
                        a.push({ type: "math", data: h, rawData: l, display: t[s].display }),
                          (e = e.slice(n + t[s].right.length));
                      }
                    ...
                    for (var o = document.createDocumentFragment(), s = 0; s < a.length; s++)
                      if ("text" === a[s].type) o.appendChild(document.createTextNode(a[s].data));
                        ...
                        try {
                          ...
                          n.errorCallback(
                            "KaTeX auto-render: Failed to parse `" + a[s].data + "` with ",
                            e,
                          ),
                  ...
                  s = function e(t, r) {
                    for (var n = 0; n < t.childNodes.length; n++) {
                      ...
                      if (3 === a.nodeType) {
                        for (
                          var i = a.textContent, s = a.nextSibling, l = 0;
      ...
      "undefined" != typeof self && self,
        (t = function () {
          return (function () {
            ...
            var F = V,
              ...
              X = function (e, t) {
                ...
                if (e.unit in G) r = G[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                  ...
                  var a;
                  if (
                    ((a = t.style.isTight() ? t.havingStyle(t.style.text()) : t), "ex" === e.unit)
                  )
                  ...
                  (t.toNode = function () {
                    ...
                    return (
                      this.alternate
                        ...
                        : e.setAttribute("d", C[this.pathName]),
                      e
                    );
                  }),
                  (t.toMarkup = function () {
            ...
            for (
              var qe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Ie = 0;
              Ie < 52;
              Ie++
            ) {
              var Re = qe.charAt(Ie);
            ...
            var Fe = [
              ...
              Qe = {
                ...
                makeVList: function (e, t) {
                  ...
                  var z = _e(["vlist-t"], x);
                  return (
                    2 === x.length && z.classes.push("vlist-t2"), (z.height = u), (z.depth = -m), z
                  );
                },
                makeOrd: function (e, t, r) {
                  ...
                  if (l) {
                    ...
                    if ("boldsymbol" === l) {
                      ...
                      s
                        ? ((u = Ke[l].fontName), (p = [l]))
                        : ((u = Ze(l, t.fontWeight, t.fontShape)),
              ...
              vt = function (e, t, r, n) {
                ...
                if (1 === e.length) {
                  ...
                  "sizing" === c.type
                    ...
                    : "styling" === c.type && (h = t.havingStyle(ft[c.style]));
                }
                ...
                return (
                  yt(
                    ...
                    function (e, t) {
                      ...
                      "mbin" === r && l(dt, n)
                        ? (t.classes[0] = "mord")
                        : "mbin" === n && l(pt, r) && (e.classes[0] = "mord");
                    },
                    { node: m },
                    u,
                    p,
              ...
              for (var i, o = [], s = [], l = 0; l < a.length; l++)
                if (
                  ...
                  a[l].hasClass("newline") &&
                    (s.pop(), s.length > 0 && (o.push(Mt(s, t)), (s = [])), o.push(a[l]));
              s.length > 0 && o.push(Mt(s, t)),
                r ? (((i = Mt(vt(r, t, !0))).classes = ["tag"]), o.push(i)) : n && o.push(n);
            ...
            function Et(e, t, r, n, a) {
              var i,
                o = Rt(e, r);
              i =
                1 === o.length && o[0] instanceof Tt && l(["mrow", "mtable"], o[0].type)
                  ? o[0]
                  : new Nt.MathNode("mrow", o);
            ...
            var Lt = function (e) {
              ...
              Gt = function (e, t) {
                var r = (function () {
                  ...
                  i = r.height;
                return (
                  (n.height = i), (n.style.height = W(i)), a > 0 && (n.style.minWidth = W(a)), n
                );
              };
            function Ut(e, t) {
              if (!e || e.type !== t)
            ...
            var Wt = function (e, t) {
                ...
                if (n.isStretchy)
                    ...
                    (l = Qe.makeVList(
                      {
                        ...
                        children: [
                          { type: "elem", elem: i },
                          {
                            ...
                            wrapperStyle:
                              o > 0
                                ? { width: "calc(100% - " + W(2 * o) + ")", marginLeft: W(2 * o) }
                                : void 0,
                          },
                        ],
                      },
                  ...
                  "\\vec" === n.label
                    ...
                    : (((m = ie(
                        (m = Qe.makeOrd({ mode: n.mode, text: n.label }, t, "textord")),
                      )).italic = 0),
                      (d = m.width),
                      h && (c += m.depth)),
              ...
              Br = function (e, t, r, n) {
                for (
                  ...
                  var i = lr(e, Tr(r[a]), "math"),
                    o = i.height + i.depth;
                  if (
                    ("small" === r[a].type && (o *= n.havingBaseStyle(r[a].style).sizeMultiplier),
                    o > t)
                  )
                    return r[a];
                }
            ...
            lt({
              ...
              htmlBuilder: function (e, t) {
                return "." === e.delim
                  ? Qe.makeSpan([e.mclass])
                  : Cr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]);
              },
                ...
                htmlBuilder: function (e, t) {
                  ...
                  if (
                    ...
                    (r =
                      "." === e.left
                        ? kt(t, ["mopen"])
                        : Cr.leftRightDelim(e.left, i, o, t, e.mode, ["mopen"])),
                    a.unshift(r),
                    s)
                  )
            ...
            var Or = function (e, t) {
                var r,
                  ...
                  h = p(e.body);
                if ("sout" === o)
                  ((r = Qe.makeSpan(["stretchy", "sout"])).height =
                  ...
                  /box/.test(o)
                    ...
                    /fbox|boxed|fcolorbox/.test(o)
                      ...
                      : "angl" === o &&
                        0.049 !== b &&
                        ((r.style.borderTopWidth = W(b)), (r.style.borderRightWidth = W(b))),
                    (l = i.depth + y),
                    e.backgroundColor &&
                ...
                return (
                  ...
                  /cancel/.test(o) && !h
                    ? Qe.makeSpan(["mord", "cancel-lap"], [a], t)
                    : Qe.makeSpan(["mord"], [a], t)
                );
              },
              Er = function (e, t) {
                var r = 0,
                  n = new Nt.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [
                    Ot(e.body, t),
                  ]);
                switch (e.label) {
                  case "\\cancel":
              ...
              function w() {
                b &&
                  (e.gullet.macros.get("\\df@tag")
                    ? (b.push(e.subparse([new Gr("\\df@tag")])),
            ...
            var jr = function (e, t) {
                ...
                function x(e) {
                  for (var t = 0; t < e.length; ++t)
                    t > 0 && (b += 0.25), c.push({ pos: b, isDashed: e[t] });
                }
                ...
                if (
                  ...
                  for (r = 0; r < i; ++r) {
                    ...
                    ((D =
                      !0 === L
                        ? Qe.makeSpan(["eqn-num"], [], t)
                        : Qe.makeSpan([], !1 === L ? [] : vt(L, t, !0), t)).depth = O.depth),
                      (D.height = O.height),
                ...
                for (a = 0, C = 0; a < s || C < I.length; ++a, ++C) {
                  for (var P = I[C] || {}, V = !0; "separator" === P.type; ) {
                    if (
                      (V ||
                        (((N = Qe.makeSpan(["arraycolsep"], [])).style.width = W(
                ...
                if (((l = Qe.makeSpan(["mtable"], R)), c.length > 0)) {
                  for (
                    var K = Qe.makeLineSpan("hline", t, m),
                      J = Qe.makeLineSpan("hdashline", t, m),
              ...
              Zr = function (e, t) {
                for (
                  var r = [],
                    n = new Nt.MathNode("mtd", [], ["mtr-glue"]),
                    a = new Nt.MathNode("mtd", [], ["mml-eqn-num"]),
                    i = 0;
                  i < e.body.length;
                  i++
                ) {
                ...
                if (e.cols && e.cols.length > 0) {
                  ...
                  for (var y = g; y < v; y++)
                    "align" === p[y].type
                      ...
                      : "separator" === p[y].type &&
                        f &&
                        ((d += "|" === p[y].separator ? "solid " : "dashed "), (f = !1));
                ...
                return (
                  ...
                  "" !== m &&
                    (h = new Nt.MathNode("menclose", [h])).setAttribute("notation", m.trim()),
                  e.arraystretch &&
                    e.arraystretch < 1 &&
                    (h = new Nt.MathNode("mstyle", [h])).setAttribute("scriptlevel", "1"),
                  h
                );
              },
              Kr = function (e, t) {
            ...
            lt({
              ...
              handler: function (e, t) {
                var r = e.parser,
                  ...
                  i = n;
                return (
                  i in tn && (i = tn[i]), { type: "font", mode: r.mode, font: i.slice(1), body: a }
                );
              },
              htmlBuilder: Qr,
              mathmlBuilder: en,
            ...
            var rn = function (e, t) {
              ...
              nn = function (e, t) {
                ...
                if (
                  (e.hasBarLine
                    ? (e.barSize
                        ? ((c = X(e.barSize, t)), (h = Qe.makeLineSpan("frac-line", t, c)))
                        : (h = Qe.makeLineSpan("frac-line", t)),
                      (c = h.height),
                      (m = h.height))
                ...
                return (
                  ...
                  (v =
                    null == e.leftDelim
                      ? kt(t, ["mopen"])
                      : Cr.customSizedDelim(e.leftDelim, g, !0, t.havingStyle(n), e.mode, [
                          "mopen",
                        ])),
                  (y = e.continued
                    ? Qe.makeSpan([])
                    : null == e.rightDelim
                      ? kt(t, ["mclose"])
                      : Cr.customSizedDelim(e.rightDelim, g, !0, t.havingStyle(n), e.mode, [
                          "mclose",
                        ])),
                  Qe.makeSpan(
                    ["mord"].concat(r.sizingClasses(t)),
                    [v, Qe.makeSpan(["mfrac"], [f]), y],
                    t,
                  )
                );
              },
              an = function (e, t) {
                ...
                if (null != e.leftDelim || null != e.rightDelim) {
                  ...
                  if ((o.push(r), null != e.rightDelim)) {
                    var l = new Nt.MathNode("mo", [
                      new Nt.TextNode(e.rightDelim.replace("\\", "")),
                    ]);
            ...
            var ln = function (e, t) {
              ...
              "supsub" === e.type
                ? ((r = e.sup
                    ? St(e.sup, t.havingStyle(a.sup()), t)
                    : St(e.sub, t.havingStyle(a.sub()), t)),
            ...
            lt({
              ...
              lt({
                ...
                mathmlBuilder: function (e, t) {
                  var r = Ht(e.body, t);
                  return (
                    r instanceof Tt || (r = new Tt("mrow", [r])), r.setAttribute("href", e.href), r
                  );
                },
              }),
              lt({
              ...
              lt({
                ...
                handler: function (e, t) {
                  ...
                  return a.settings.isTrusted(r)
                    ? { type: "html", mode: a.mode, attributes: l, body: mt(s) }
            ...
            var mn = function (e, t, r, n, a, i, o) {
              ...
              pn = function (e, t) {
                ...
                var o,
                  ...
                  h = !1;
                if (
                  (s.size === A.DISPLAY.size && a.symbol && !l(un, a.name) && (h = !0), a.symbol)
                ) {
                  ...
                  if (
                    ...
                    (o = Qe.makeSymbol(a.name, c, "math", t, [
                      "mop",
                      "op-symbol",
                      h ? "large-op" : "small-op",
                    ])),
            ...
            function yn(e, t, r) {
              for (
                var n = vt(e, t, !1), a = t.sizeMultiplier / r.sizeMultiplier, i = 0;
                i < n.length;
                i++
              ) {
            ...
            lt({
              ...
              mathmlBuilder: function (e, t) {
                ...
                return e.parentIsSupSub
                  ? new Nt.MathNode("mrow", [l, h])
                  : Nt.newDocumentFragment([l, h]);
              },
            }),
              ...
              ht({
                ...
                htmlBuilder: function (e, t) {
                  return e.semisimple
                    ? Qe.makeFragment(vt(e.body, t, !1))
                    : Qe.makeSpan(["mord"], vt(e.body, t, !0), t);
                },
                mathmlBuilder: function (e, t) {
              ...
              lt({
                ...
                mathmlBuilder: function (e, t) {
                  var r = e.body,
                    n = e.index;
                  return n
                    ? new Nt.MathNode("mroot", [Ot(r, t), Ot(n, t)])
                    : new Nt.MathNode("msqrt", [Ot(r, t)]);
                },
              });
            var xn = {
              display: A.DISPLAY,
            ...
            ht({
              ...
              htmlBuilder: function (e, t) {
                ...
                if (s) {
                  ...
                  (n = St(s, f, t)),
                    d ||
                      (m =
                        h.height - (f.fontMetrics().supDrop * f.sizeMultiplier) / t.sizeMultiplier);
                }
                if (l) {
                  ...
                  (a = St(l, g, t)),
                    d ||
                      (u =
                        h.depth + (g.fontMetrics().subDrop * g.sizeMultiplier) / t.sizeMultiplier);
                }
              ...
              mathmlBuilder: function (e, t) {
                ...
                var a,
                  i = [Ot(e.base, t)];
                if ((e.sub && i.push(Ot(e.sub, t)), e.sup && i.push(Ot(e.sup, t)), n))
                  a = r ? "mover" : "munder";
                else if (e.sub)
                  if (e.sup) {
                    var o = e.base;
            ...
            ht({
              ...
              mathmlBuilder: function (e, t) {
                var r = new Nt.MathNode("mtable", [
                  new Nt.MathNode("mtr", [
                    Mn(),
                    new Nt.MathNode("mtd", [Ht(e.body, t)]),
                    Mn(),
                    new Nt.MathNode("mtd", [Ht(e.tag, t)]),
                  ]),
                ]);
              ...
              Bn = function (e, t) {
                ...
                return r
                  ? zn[r]
                    ...
                    : An[r]
                      ? t.withTextFontWeight(An[r])
                      : t.withTextFontShape(Tn[r])
                  : t;
              };
            lt({
              type: "text",
                ...
                return (
                  ...
                  (t._getExpansion = function (e) {
                    ...
                    if ("string" == typeof n) {
                      ...
                      for (
                        var o = new En(n, this.settings), s = [], l = o.lex();
                        "EOF" !== l.text;
                  ...
                  (t.isExpandable = function (e) {
                    ...
                    return null != t
                      ...
                      : Cn.hasOwnProperty(e) && !Cn[e].primitive;
                  }),
                  e
                );
              })(),
            ...
            var Jn = function (e, t) {
                ...
                if (
                  ...
                  a = [
                    { type: "tag", mode: "text", body: a, tag: r.subparse([new Gr("\\df@tag")]) },
                  ];
                }
                return a;
              },
