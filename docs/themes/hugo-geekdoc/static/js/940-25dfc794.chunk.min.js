  ...
  [940],
  {
    5940: function (t, e, n) {
      ...
      var i = n(9339),
        ...
        c =
          ...
          (function () {
                ...
                parse: function (t) {
                  ...
                  for (var y, f, m, _, b, v, k, x, S, w = {}; ; ) {
                    if (
                      ...
                      var $;
                      for (b in ((x = []), r[f]))
                        this.terminals_[b] && b > 2 && x.push("'" + this.terminals_[b] + "'");
                      ($ = h.showPosition
                        ? "Parse error on line " +
                          (o + 1) +
                          ":\n" +
            ...
            return (p.lexer = g), (y.prototype = p), (p.Parser = y), new y();
          })());
      c.parser = c;
      const l = c;
      let h = "",
      ...
      const u = [],
        ...
        y = () => i.M,
        f = (t, e, n) => {
          (0, i.D)(globalThis, t, e, n);
        },
        m = function () {
          (u.length = 0), (p.length = 0), (h = ""), (g.length = 0), (0, i.v)();
        },
        _ = function (t) {
          (h = t), u.push(t);
        },
        ...
        C = function (t, e, n, s, r, a, o, c, l, h, d) {
          ...
          for (const c of e) {
            ...
            const p = t.append("g").attr("class", "taskWrapper"),
              g = D(p, e, n, o).height;
            if (
              (i.l.debug("taskHeight after draw", g),
              p.attr("transform", `translate(${s}, ${r})`),
              (a = Math.max(a, g)),
              c.events)
            ) {
        ...
        M = {
          ...
          renderer: {
            ...
            draw: function (t, e, n, r) {
              ...
              const u = (
                "sandbox" === h ? (0, s.Ys)(d.nodes()[0].contentDocument.body) : (0, s.Ys)("body")
              ).select("#" + e);
              u.append("g");
              ...
              y.forEach(function (t) {
                const e = T(
                  u,
                  { number: x, descr: t, section: x, width: 150, padding: 20, maxHeight: f },
                  c,
                );
              ...
              for (const [t, e] of p.entries()) {
                const n = {
                  ...
                  s = T(u, n, c);
                i.l.debug("taskHeight before draw", s),
                  (m = Math.max(m, s + 20)),
                ...
                y && y.length > 0
                  ? y.forEach((t) => {
                      ...
                      i.l.debug("sectionNode output", r),
                        s.attr("transform", `translate(${v}, 50)`),
                        (k += f + 50),
                        e.length > 0 && C(u, e, x, v, k, m, c, 0, $, f, !1),
                        (v += 200 * Math.max(e.length, 1)),
                        (k = 50),
                        x++;
                    })
                  : ((S = !1), C(u, p, x, v, k, m, c, 0, $, f, !0));
              ...
              i.l.debug("bounds", E),
                ...
                (0, i.p)(
                  void 0,
                  u,
                  (null == (a = c.timeline) ? void 0 : a.padding) ?? 50,
                  (null == (o = c.timeline) ? void 0 : o.useMaxWidth) ?? !1,
                );
            },
          },
          parser: l,
