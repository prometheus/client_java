          ...
          (r = {
            ...
            storeAPI: {
              ...
              namespace: function (t, e, n) {
                ...
                var i = t,
                  s = this[i];
                if (!((s && s.namespace) || (((s = r.Store(this._id, this._area, this._ns + i + n))._delim = n), this[i] || (this[i] = s), e)))
              ...
              set: function (t, e, n) {
                ...
                return null != s && !1 === n
                  ? e
                  : ("function" == typeof n && ((i = n), (n = void 0)), r.set(this._area, this._in(t), r.stringify(e, i), n) || s);
              },
              setAll: function (t, e) {
                var n, r;
