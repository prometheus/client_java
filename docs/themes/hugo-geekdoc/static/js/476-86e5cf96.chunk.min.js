  ...
  [476],
  {
    ...
    6476: function (e, t, n) {
      ...
      let c = {},
        ...
        g = {};
      const f = (e, t) => (
          d.l.trace("In isDecendant", t, " ", e, " = ", h[t].includes(e)), !!h[t].includes(e)
        ),
        u = (e, t, n, r) => {
            ...
            i.forEach((i) => {
              if (t.children(i).length > 0) u(i, t, n, r);
                ...
                d.l.info("cp ", i, " to ", r, " with parent ", e),
                  n.setNode(i, a),
                  r !== t.parent(i) &&
                    (d.l.warn("Setting parent", i, t.parent(i)), n.setParent(i, t.parent(i))),
                  e !== r && i !== e
        ...
        p = (e, t) => {
          ...
          const n = t.children(e);
          if ((d.l.trace("Searching children of id ", e, n), n.length < 1))
            return d.l.trace("This is a valid node", e), e;
          for (const r of n) {
            const n = p(r, t);
        ...
        y = (e, t) => {
          if ((d.l.warn("extractor - ", t, i.c(e), e.children("D")), t > 10))
            return void d.l.error("Bailing out");
          let n = e.nodes(),
            r = !1;
          for (const t of n) {
              ...
              if (
                ...
                if (!c[r].externalConnections && e.children(r) && e.children(r).length > 0) {
                  ...
                  c[r] &&
                    c[r].clusterData &&
                    c[r].clusterData.dir &&
                    ((n = c[r].clusterData.dir), d.l.warn("Fixing dir", c[r].clusterData.dir, n));
        ...
        m = {
          rect: (e, t) => {
            ...
            t.width <= h.width + g
              ...
              i
                ? o.attr(
                    "transform",
                    "translate(" + (t.x - h.width / 2) + ", " + (t.y - t.height / 2) + ")",
                  )
          ...
          roundedWithTitle: (e, t) => {
            ...
            t.width <= c.width + t.padding
              ? (t.diff = (c.width + 0 * t.padding - t.width) / 2)
              : (t.diff = -t.padding / 2),
              r
                .attr("class", "outer")
                .attr("x", t.x - f / 2 - g)
              ...
              i.attr(
                ...
                "translate(" +
                  ...
                  (t.y -
                    t.height / 2 -
                    t.padding / 3 +
                    ((0, d.n)((0, d.c)().flowchart.htmlLabels) ? 5 : 3)) +
                  ")",
              );
      ...
      const N = async (e, t, n, o) => {
          ...
          t.nodes()
            ? d.l.info("Recursive render XXX", t.nodes())
            : d.l.info("No nodes found for", t),
          ...
          await Promise.all(
            t.nodes().map(async function (e) {
              ...
              if (
                (d.l.info("(Insert) Node XXX" + e + ": " + JSON.stringify(t.node(e))),
                r && r.clusterNode)
              ) {
                ...
                t.children(e).length > 0
                  ? (d.l.info("Cluster - the non recursive path XXX", e, r.id, r, t),
                    d.l.info(p(r.id, t)),
                    (c[r.id] = { id: p(r.id, t), node: r }))
                  : (d.l.info("Node - the non recursive path", e, r.id, r),
                    await (0, a.e)(u, t.node(e), l));
            }),
          ),
