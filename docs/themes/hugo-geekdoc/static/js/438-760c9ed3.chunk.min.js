      ...
      const x = (function () {
        ...
        T = {
          ...
          draw: function (t, e, n, s) {
            ...
            const l =
              "sandbox" === o ? (0, r.Ys)(c.nodes()[0].contentDocument.body) : (0, r.Ys)("body");
            M.init();
            const h = l.select("#" + e);
            h.append("defs")
              .append("marker")
            ...
            const $ = y ? 70 : 0;
            h.attr("viewBox", `${f.startx} -25 ${x} ${g + $}`),
