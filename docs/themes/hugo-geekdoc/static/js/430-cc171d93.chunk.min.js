...
(self.webpackChunkgeekdoc = self.webpackChunkgeekdoc || []).push([
  [430],
  {
    4430: function (t, e, r) {
            ...
            if (
              ...
              (n = (function (t) {
                ...
                for (let t = 0; t < a; ++t) {
                  ...
                  for (let t = 16; t < 80; ++t)
                    i[t] = d(i[t - 3] ^ i[t - 8] ^ i[t - 14] ^ i[t - 16], 1);
                  let a = r[0],
                    s = r[1],
                    o = r[2],
                    c = r[3],
            ...
            var t = function (t, e, r, i) {
                ...
                performAction: function (t, e, r, i, a, n, s) {
                  ...
                  switch (a) {
                    ...
                    case 12:
                      i.addEntity(n[o - 4]),
                        i.addEntity(n[o - 2]),
                        i.addRelationship(n[o - 4], n[o], n[o - 2], n[o - 3]);
                      break;
                    case 13:
                    ...
                    case 47:
                      (n[o] = n[o].trim().replace(/'/g, '"')),
                        i.parseDirective(n[o], "arg_directive");
                      break;
                    case 48:
                ...
                parse: function (t) {
                  ...
                  for (var _, f, g, m, E, O, b, k, R, N = {}; ; ) {
                    if (
                      ...
                      var T;
                      for (E in ((k = []), n[f]))
                        this.terminals_[E] && E > 2 && k.push("'" + this.terminals_[E] + "'");
                      (T = h.showPosition
                        ? "Parse error on line " +
                          (o + 1) +
                          ":\n" +
                    ...
                    if (g[0] instanceof Array && g.length > 1)
                      throw new Error(
                        "Parse Error: multiple actions possible at state: " + f + ", token: " + _,
                      );
                    switch (g[0]) {
                      case 1:
                        e.push(_),
              ...
              x = {
                ...
                conditions: {
                  ...
                  INITIAL: {
                    rules: [
                      0, 2, 4, 7, 12, 13, 14, 15, 16, 17, 18, 28, 29, 30, 31, 32, 33, 34, 35, 36,
      ...
      const g = function (t) {
          return (
            void 0 === _[t] && ((_[t] = { attributes: [] }), i.l.info("Added new entity :", t)),
            _[t]
          );
        },
        m = {
          ...
          addAttributes: function (t, e) {
            ...
            for (r = e.length - 1; r >= 0; r--)
              a.attributes.push(e[r]), i.l.debug("Added attribute ", e[r].attributeName);
          },
          getEntities: () => _,
      ...
      const v = {
        ...
        renderer: {
          ...
          draw: function (t, e, r, o) {
            ...
            const h = (
              "sandbox" === c ? (0, n.Ys)(l.nodes()[0].contentDocument.body) : (0, n.Ys)("body")
            ).select(`[id='${e}']`);
            let d;
            (function (t, e) {
              let r;
                    ...
                    const c = "text-" + s,
                      ...
                      { width: h, height: d } = ((t, e, r) => {
                        ...
                        let l = !1,
                          ...
                          f = 1;
                        r.forEach((t) => {
                          void 0 !== t.attributeKeyTypeList &&
                            t.attributeKeyTypeList.length > 0 &&
                            (l = !0),
                          ...
                          r.forEach((r) => {
                            ...
                            const b = m.node().getBBox(),
                              k = E.node().getBBox();
                            if (
                              ((d = Math.max(d, b.width)),
                              (u = Math.max(u, k.width)),
                              (o = Math.max(b.height, k.height)),
                              l)
                            ) {
                              const e =
                                  void 0 !== r.attributeKeyTypeList
                                    ? r.attributeKeyTypeList.join(",")
                                    : "",
                                a = t
                                  .append("text")
                                  .classed("er entityLabel", !0)
                        ...
                        const m = d + u + y + p,
                          E = {
                            width: Math.max(
                              k.minEntityWidth,
                              Math.max(o.width + 2 * k.entityPadding, m + n * g),
                            ),
                            height:
                              r.length > 0
                                ? _
                                : Math.max(k.minEntityHeight, o.height + 2 * k.entityPadding),
                          };
                        if (r.length > 0) {
                          const r = Math.max(0, (E.width - m - n * g) / (g / 2));
                          e.attr(
                            "transform",
                            "translate(" + E.width / 2 + "," + (a + o.height / 2) + ")",
                          );
                          let i = o.height + 2 * a,
                            s = "attributeBoxOdd";
                          c.forEach((e) => {
                            ...
                            h &&
                              ...
                              (i += e.height + 2 * a),
                              (s =
                                "attributeBoxOdd" === s ? "attributeBoxEven" : "attributeBoxOdd");
                          });
                        } else
                          (E.height = Math.max(k.minEntityHeight, _)),
                            e.attr(
                              "transform",
              ...
              (f = d).nodes().forEach(function (t) {
                void 0 !== t &&
                  ...
                  _.select("#" + t).attr(
                    "transform",
                    "translate(" +
                      (f.node(t).x - f.node(t).width / 2) +
                      "," +
                      (f.node(t).y - f.node(t).height / 2) +
                      " )",
                  );
              }),
                ...
                !(function (t, e, r, a, s) {
                  ...
                  const o = r.edge(R.get(e.entityA), R.get(e.entityB), N(e)),
                    ...
                    l = t
                      ...
                      .style("fill", "none");
                  e.relSpec.relType === s.db.Identification.NON_IDENTIFYING &&
