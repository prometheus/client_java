            ...
            (a.prototype.move = function () {
              ...
              (this.displacementX =
                ...
                Math.abs(this.displacementX) > e.coolingFactor * e.maxNodeDisplacement &&
                  (this.displacementX =
                    e.coolingFactor * e.maxNodeDisplacement * i.sign(this.displacementX)),
                Math.abs(this.displacementY) > e.coolingFactor * e.maxNodeDisplacement &&
                  (this.displacementY =
                    e.coolingFactor * e.maxNodeDisplacement * i.sign(this.displacementY)),
            ...
            (m.prototype.newGraphManager = function () {
              ...
              (m.prototype.calculateNodesToApplyGravitationTo = function () {
                var e,
                  ...
                  i = r.length;
                for (t = 0; t < i; t++)
                  (e = r[t]).updateConnected(), e.isConnected || (n = n.concat(e.getNodes()));
                return n;
              }),
              ...
              (m.prototype.positionNodesRadially = function (e) {
                for (
                  ...
                  s % n == 0 &&
                    ((a = 0), (i = r), 0 != s && (i += l.DEFAULT_COMPONENT_SEPERATION), (r = 0));
                  var u = e[s],
              ...
              (m.prototype.clearZeroDegreeMembers = function () {
                ...
                Object.keys(this.memberGroups).forEach(function (n) {
                  ...
                  (t[n] = e.tileNodes(e.memberGroups[n], r.paddingLeft + r.paddingRight)),
              ...
              (m.prototype.fillCompexOrderByDFS = function (e) {
                for (var t = 0; t < e.length; t++) {
                  var n = e[t];
                  null != n.getChild() && this.fillCompexOrderByDFS(n.getChild().getNodes()),
              ...
              (m.prototype.insertNodeToRow = function (e, t, n, r) {
                ...
                var s = 0;
                o > e.rowHeight[n] &&
                  ((s = e.rowHeight[n]), (e.rowHeight[n] = o), (s = e.rowHeight[n] - s)),
                  (e.height += s),
                  e.rows[n].push(t);
              }),
              (m.prototype.getShortestRowIndex = function (e) {
                for (var t = -1, n = Number.MAX_VALUE, r = 0; r < e.rows.length; r++)
                  e.rowWidth[r] < n && ((t = r), (n = e.rowWidth[r]));
                return t;
              }),
              (m.prototype.getLongestRowIndex = function (e) {
                for (var t = -1, n = Number.MIN_VALUE, r = 0; r < e.rows.length; r++)
                  e.rowWidth[r] > n && ((t = r), (n = e.rowWidth[r]));
                return t;
              }),
              (m.prototype.canAddHorizontal = function (e, t, n) {
                ...
                return (
                  ...
                  (o = e.width < t ? (e.height + s) / t : (e.height + s) / e.width) < 1 &&
                    (o = 1 / o),
                  a < 1 && (a = 1 / a),
                  a < o
                );
              ...
              (m.prototype.findPlaceforPrunedNode = function (e) {
                ...
                if (o > 0)
                  for (var c = i; c <= a; c++)
                    l[0] += this.grid[c][o - 1].length + this.grid[c][o].length - 1;
                if (a < this.grid.length - 1)
                  for (c = o; c <= s; c++)
                    l[1] += this.grid[a + 1][c].length + this.grid[a][c].length - 1;
                if (s < this.grid[0].length - 1)
                  for (c = i; c <= a; c++)
                    l[2] += this.grid[c][s + 1].length + this.grid[c][s].length - 1;
                if (i > 0)
                  for (c = o; c <= s; c++)
                    l[3] += this.grid[i - 1][c].length + this.grid[i][c].length - 1;
          ...
          function (e, t, n) {
            ...
            var d = function (e) {
              null != e.nodeRepulsion &&
                (a.DEFAULT_REPULSION_STRENGTH = i.DEFAULT_REPULSION_STRENGTH = e.nodeRepulsion),
                null != e.idealEdgeLength &&
                  (a.DEFAULT_EDGE_LENGTH = i.DEFAULT_EDGE_LENGTH = e.idealEdgeLength),
                null != e.edgeElasticity &&
                  (a.DEFAULT_SPRING_STRENGTH = i.DEFAULT_SPRING_STRENGTH = e.edgeElasticity),
                null != e.nestingFactor &&
                  (a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = i.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                    e.nestingFactor),
                null != e.gravity &&
                  (a.DEFAULT_GRAVITY_STRENGTH = i.DEFAULT_GRAVITY_STRENGTH = e.gravity),
                null != e.numIter && (a.MAX_ITERATIONS = i.MAX_ITERATIONS = e.numIter),
                null != e.gravityRange &&
                  (a.DEFAULT_GRAVITY_RANGE_FACTOR = i.DEFAULT_GRAVITY_RANGE_FACTOR =
                    e.gravityRange),
                null != e.gravityCompound &&
                  (a.DEFAULT_COMPOUND_GRAVITY_STRENGTH = i.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                    e.gravityCompound),
                ...
                null != e.initialEnergyOnIncremental &&
                  (a.DEFAULT_COOLING_FACTOR_INCREMENTAL = i.DEFAULT_COOLING_FACTOR_INCREMENTAL =
                  ...
                  n.eles.nodes().positions(function (e, t) {
                    if (("number" == typeof e && (e = t), !e.isParent())) {
                      for (
                        ...
                        null == r &&
                        ((r = c[i.data("parent")] || c["DummyCompound_" + i.data("parent")]),
                        (c[n] = r),
                        null != (i = i.parent()[0]));
      ...
      e.exports = (function () {
        ...
        var be = function (e, t, n) {
            ...
            return (
              ...
              U(n) &&
                ((c = !!n.leading),
                (a = (h = "maxWait" in n) ? ye(ve(n.maxWait) || 0, t) : a),
          ...
          Ne = function (e) {
            for (
              var t, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : De;
              !(t = e.next()).done;
          ...
          Ae = function (e) {
            return (
              (65599 * (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : De) + e) |
              0
            );
          },
          Le = function (e) {
          ...
          it = function (e, t) {
            ...
            if (void 0 !== e && void 0 !== t && T(e)) {
              ...
              if (
                (null == r &&
                  (r =
                    t.data && null != t.data.source && null != t.data.target ? "edges" : "nodes"),
                "nodes" === r || "edges" === r)
              ) {
        ...
        var st = (function (e, t) {
          ...
          ct = {
            dijkstra: function (e) {
              ...
              for (
                var E = function (e, t) {
                  for (
                    var n, r = (a ? e.edgesTo(t) : e.edgesWith(t)).intersect(g), i = 1 / 0, o = 0;
                    o < r.length;
                    o++
                  ) {
                    var l = r[o],
            ...
            aStar: function (e) {
              ...
              for (var w = 0; v.size() > 0; ) {
                if (((l = v.pop()), (u = l.id()), y.delete(u), w++, u === d)) {
                  for (
                    var E = [], _ = i, T = d, D = b[T];
                    E.unshift(_), null != D && E.unshift(D), null != (_ = m[T]);
                ...
                R = {
                  ...
                  path: function (e, n) {
                    ...
                    var o,
                      ...
                      l = r;
                    for (s.merge(a); r !== i; )
                      (l = r), (r = m[r * u + i]), (o = b[l * u + r]), s.merge(o), s.merge(d(r));
                    return s;
                  },
                };
              return R;
              ...
              for (
                var _ = !1,
                  T = function (e, t, n, r, i, a) {
                    ...
                    o < i.dist &&
                      !n.same(r.edge) &&
                      ((i.dist = o), (i.pred = e), (i.edge = n), (_ = !0));
                  },
                  D = 1;
                D < d;
                D++
              ...
              if (_)
                for (var M = [], O = 0; O < y; O++) {
                  ...
                  if (z + F < G || (!i && G + F < z)) {
                    if (
                      (g ||
                        (je("Graph contains a negative weight cycle for Bellman-Ford"), (g = !0)),
                    ...
                    for (var X = Y.length, V = 0; V < X; V++) {
                      var U = Y[V],
                        j = [U];
                      j.push(m(U).edge);
                      for (var q = m(U).pred; -1 === j.indexOf(q); )
                        j.push(q), j.push(m(q).edge), (q = m(q).pred);
                      for (
                        var H = (j = j.slice(j.indexOf(q)))[0].id(), W = 0, $ = 2;
                        $ < j.length;
                        $ += 2
                      )
                        j[$].id() < H && ((H = j[$].id()), (W = $));
          ...
          Xt = function (e, t, n, r, i, a, o) {
            ...
            var v = n - u + l,
              y = r - c + l;
            if ((g = Qt(e, t, n, r, v, y, l + o)).length > 0 && g[0] <= v && g[1] <= y)
              return [g[0], g[1]];
            var m = n + u - l,
              b = r - c + l;
            if ((g = Qt(e, t, n, r, m, b, l + o)).length > 0 && g[0] >= m && g[1] <= b)
              return [g[0], g[1]];
            var x = n + u - l,
              w = r + c - l;
            if ((g = Qt(e, t, n, r, x, w, l + o)).length > 0 && g[0] >= x && g[1] >= w)
              return [g[0], g[1]];
            var E = n - u + l,
              _ = r + c - l;
            return (g = Qt(e, t, n, r, E, _, l + o)).length > 0 && g[0] <= E && g[1] >= _
              ? [g[0], g[1]]
              : [];
          },
          ...
          jt = function (e, t, n, r, i, a, o, s) {
            ...
            (u =
              ...
              p > 0
                ...
                : ((d[5] = d[3] = 0),
                  0 === p
                    ? ((x = f < 0 ? -Math.pow(-f, 1 / 3) : Math.pow(f, 1 / 3)),
                      (d[0] = 2 * x - b),
                      (d[4] = d[2] = -(x + b)))
                    : ((v = (g = -g) * g * g),
            ...
            for (var E = [], _ = 0; _ < 6; _ += 2)
              Math.abs(w[_ + 1]) < 1e-7 && w[_] >= 0 && w[_] <= 1 && E.push(w[_]);
            E.push(1), E.push(0);
          ...
          Qt = function (e, t, n, r, i, a, o) {
            ...
            var d = (-c + Math.sqrt(h)) / (2 * u),
              ...
              f = Math.max(d, p),
              v = [];
            if ((g >= 0 && g <= 1 && v.push(g), f >= 0 && f <= 1 && v.push(f), 0 === v.length))
              return [];
            var y = v[0] * s[0] + e,
              m = v[0] * s[1] + t;
            return v.length > 1
          ...
          tn = function (e, t, n, r, i, a, o, s) {
            ...
            if ((null == a && (v = !1), v)) {
              for (var y = 0; y < f.length / 2; y++)
                (f[2 * y] = n[2 * y] * a + r), (f[2 * y + 1] = n[2 * y + 1] * o + i);
              if (s > 0) {
                var m = Kt(f, -s);
                u = $t(m);
              } else u = f;
        ...
        (pn.dc = pn.degreeCentrality),
          (pn.dcn = pn.degreeCentralityNormalised = pn.degreeCentralityNormalized);
        var gn = Ke({
            harmonic: !0,
            weight: function () {
              return 1;
                      ...
                      if ((n.push(f), i))
                        for (var v = 0; v < s[f].length; v++) {
                          ...
                          (m = m.id()),
                            h[m] > h[f] + x &&
                              ((h[m] = h[f] + x),
                              d.nodes.indexOf(m) < 0 ? d.push(m) : d.updateItem(m),
                              (u[m] = 0),
                              (l[m] = [])),
                        ...
                        for (var w = 0; w < s[f].length; w++) {
                          ...
                          h[E] == 1 / 0 && (d.push(E), (h[E] = h[f] + 1)),
                            h[E] == h[f] + 1 && ((u[E] = u[E] + u[f]), l[E].push(f));
                        }
                    }
        ...
        var mn = Ke({
          ...
          Cn = function (e) {
            ...
            return (function (e) {
              for (var t = 0; t < e.length; t++)
                for (var n = 0; n < e.length; n++) t != n && Dn(e[t], e[n]) && e.splice(n, 1);
              return e;
            })(b);
          },
          ...
          On = function (e, t, n, r, i) {
            for (
              var a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : An,
                o = r,
                s = 0;
              s < e;
              s++
        ...
        function Rn(e, t, n, r, i, a) {
          var o;
          return (
            (o = v(e) ? e : Pn[e] || Pn.euclidean), 0 === t && v(e) ? o(i, a) : o(t, n, r, i, a)
          );
        }
        ...
        var Bn = Ke({
          ...
          jn = function (e, t) {
            ...
            if (e.length < 50)
              for (var r = 0; r < t; r++) {
                for (var i = e[Math.floor(Math.random() * e.length)]; Un(i, n, r); )
          ...
          Kn = function (e) {
            ...
            for (var v = !0, y = 0; v && y < s.maxIterations; )
              (v = !1),
                Hn(t, o, n, i, s),
                Wn(n, r, t, o, s),
                Vn(n, r, s.sensitivityThreshold) || (v = !0),
                y++;
            ...
            kMeans: function (t) {
              ...
              u.testMode
                ? "number" == typeof u.testCentroids
                  ...
                  : (n =
                      "object" === e(u.testCentroids) ? u.testCentroids : Gn(s, u.k, u.attributes))
                : (n = Gn(s, u.k, u.attributes));
              for (var d = !0, p = 0; d && p < u.maxIterations; ) {
                for (var g = 0; g < s.length; g++)
                  h[(l = s[g]).id()] = Yn(l, n, u.distance, u.attributes, "kMeans");
                d = !1;
                for (var f = 0; f < u.k; f++) {
                  var v = Xn(f, s, h);
                  if (0 !== v.length) {
                    for (
                      var y = u.attributes.length,
                        m = n[f],
                        b = new Array(y),
                        x = new Array(y),
                        w = 0;
            ...
            kMedoids: function (t) {
              ...
              s.testMode
                ? "number" == typeof s.testCentroids ||
                  (n = "object" === e(s.testCentroids) ? s.testCentroids : jn(a, s.k))
                : (n = jn(a, s.k));
              for (var h = !0, d = 0; h && d < s.maxIterations; ) {
                for (var p = 0; p < a.length; p++)
                  u[(o = a[p]).id()] = Yn(o, n, s.distance, s.attributes, "kMedoids");
                h = !1;
          ...
          cr = function (e) {
            ...
            for (var p = 0; p < t; p++)
              for (var g = 0; g < t; g++)
                p !== g && (r[p * t + g] = sr(u.distance, l[p], l[g], u.attributes));
            i = lr(r, u.preference);
            ...
            for (var m = new Array(t), x = new Array(t), w = new Array(t), E = 0; E < t; E++)
              (m[E] = 0), (x[E] = 0), (w[E] = 0);
                ...
                for (var N = -1 / 0, A = -1 / 0, L = -1, k = 0, S = 0; S < t; S++)
                  (m[S] = a[C * t + S]),
                    (k = o[C * t + S] + r[C * t + S]) >= N
                      ...
                      : k > A && (A = k);
                for (var I = 0; I < t; I++)
                  a[C * t + I] = (1 - u.damping) * (r[C * t + I] - N) + u.damping * m[I];
                a[C * t + L] = (1 - u.damping) * (r[C * t + L] - A) + u.damping * m[L];
              }
              for (var M = 0; M < t; M++) {
                for (var O = 0, P = 0; P < t; P++)
                  (m[P] = o[P * t + M]), (x[P] = Math.max(0, a[P * t + M])), (O += x[P]);
                (O -= x[M]), (x[M] = a[M * t + M]), (O += x[M]);
                for (var R = 0; R < t; R++)
                  o[R * t + M] = (1 - u.damping) * Math.min(0, O - x[R]) + u.damping * m[R];
            ...
            for (var $ = new Array(V.length), K = 0; K < V.length; K++)
              $[K] = s.collection(j[V[K]]);
            return $;
          },
        ...
        [
          ...
          pr,
          {
            hopcroftTarjanBiconnected: gr,
            htbc: gr,
            htb: gr,
            hopcroftTarjanBiconnectedComponents: gr,
          },
        ...
        yr.prototype = {
          ...
          then: function (e, t) {
            var n = this,
              r = new yr();
            return (
              n.onFulfilled.push(wr(e, r, "fulfill")),
              n.onRejected.push(wr(t, r, "reject")),
              br(n),
              r.proxy
            );
          },
          ...
          hook: function () {
            ...
            if (!e.hooked) {
              ...
              (e.queue ? t.queue : t.current).push(this),
                w(e.target) && e.target.cy().addToAnimationPool(e.target),
                (e.hooked = !0);
            }
            return this;
          },
            ...
            animation: function () {
              return function (e, t) {
                ...
                if (o && m(e.zoom)) {
                  ...
                  null != b
                    ? (b.zoomed && (e.zoom = b.zoom), b.panned && (e.pan = b.pan))
                    : (e.zoom = null);
                }
                return new Tr(i[0], e);
              };
        ...
        var kr = function (e, t) {
          ...
          var n = typeof e;
          return (
            !("number" != n && "symbol" != n && "boolean" != n && null != e && !he(e)) ||
            Lr.test(e) ||
            !Ar.test(e) ||
        ...
        var Sr,
          ...
          Or = (Sr = /[^.]+$/.exec((Mr && Mr.keys && Mr.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + Sr
            : "";
        var Pr = function (e) {
            return !!Or && Or in e;
        ...
        (hi.prototype.clear = ri),
          (hi.prototype.delete = si),
          (hi.prototype.get = li),
          (hi.prototype.has = ui),
          (hi.prototype.set = ci);
        var di = hi,
        ...
        var gi = function () {
          (this.size = 0),
            (this.__data__ = { hash: new ni(), map: new (pi || di)(), string: new ni() });
        };
        var fi = function (e) {
          var t = typeof e;
        ...
        (wi.prototype.clear = gi),
          (wi.prototype.delete = yi),
          (wi.prototype.get = mi),
          (wi.prototype.has = bi),
          (wi.prototype.set = xi);
        var Ei = wi;
        ...
        var Fi = function (e, t, n) {
            "__proto__" == t && Bi
              ? Bi(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
              : (e[t] = n);
          },
                ...
                function (t) {
                  ...
                  if (f(t)) {
                    ...
                    for (var h = 0, d = i.length; h < d; h++)
                      for (
                        var p = i[h]._private[n.field], g = Object.keys(p), v = 0;
                        v < g.length;
                        v++
                      ) {
                        var y = g[v];
            ...
            },
            {
              ...
              populate: function (e, t, n) {
                var r = o(n, 3),
                  ...
                  s = r[2];
                (s =
                  null != new RegExp("^" + Zi.string + "$").exec(s)
              ...
              populate: function (e, t) {
                if (null == e.currentSubject) {
                  var n = { checks: [] },
                    ...
                    i = { checks: [] };
                  return (
                    n.checks.push({ type: ua, source: r, target: i }), _a(e, 0, n), e.edgeCount++, i
                  );
                }
                var a = { checks: [] },
                  o = t,
                  s = { checks: [] };
                return (
                  a.checks.push({ type: ca, source: o, target: s }), _a(e, 0, a), e.edgeCount++, s
                );
              },
            },
            {
              ...
              populate: function (e, t) {
                if (null == e.currentSubject) {
                  var n = { checks: [] },
                    ...
                    i = e[e.length - 1];
                  return (
                    n.checks.push({ type: pa, parent: i, child: r }),
                    _a(e, 0, n),
                    e.compoundCount++,
                    r
                  );
              ...
              populate: function (e, t) {
                if (null == e.currentSubject) {
                  var n = { checks: [] },
                    ...
                    i = e[e.length - 1];
                  return (
                    n.checks.push({ type: ga, ancestor: i, descendant: r }),
                    _a(e, 0, n),
                    e.compoundCount++,
                    r
                  );
            ...
            },
            {
              ...
              populate: function (e, t) {
                if (null != e.currentSubject && e.currentSubject !== t)
                  return je("Redefinition of subject in selector `" + e.toString() + "`"), !1;
                e.currentSubject = t;
            ...
            parse: function (e) {
              ...
              for (var l = 0; l < t.length; l++) {
                ...
                if (u.edgeCount > 1)
                  return (
                    je(
                      "The selector `" + e + "` is invalid because it uses multiple edge selectors",
                    ),
                    !1
                  );
                1 === u.edgeCount &&
        ...
        (Oa.allAreNeighbours = Oa.allAreNeighbors),
          (Oa.has = Oa.contains),
          (Oa.equal = Oa.equals = Oa.same);
        var Pa,
          Ra,
          Ba = function (e, t) {
            return function (n, r, i, a) {
              var o,
                ...
                l = this;
              if (
                (null == s ? (o = "") : w(s) && 1 === s.length && (o = s.id()), 1 === l.length && o)
              ) {
                var u = l[0]._private,
        ...
        ((Va = Ua =
          {
            ...
            shift: function (e, t, n) {
              ...
              if (
                (m(e)
                  ? ((r = { x: b(e.x) ? e.x : 0, y: b(e.y) ? e.y : 0 }), (n = t))
                  : f(e) && b(t) && ((r = { x: 0, y: 0 })[e] = t),
                null != r)
              ) {
                var i = this.cy();
                i.startBatch();
            ...
            if (
                    ...
                    if (b) {
                      ...
                      null != X.all
                        ...
                        c &&
                          ...
                          f &&
                            (t.includeSourceLabels && ao(d, e, "source"),
                            t.includeTargetLabels && ao(d, e, "target")));
                    }
                    return (
                      (d.x1 = eo(d.x1)),
                      (d.y1 = eo(d.y1)),
              ...
              (n = Ot()),
                ((t.includeNodes && c) || (t.includeEdges && !c)) &&
                  (t.includeOverlays ? no(n, r.overlayBounds) : no(n, r.bodyBounds)),
                t.includeLabels &&
              ...
              return (
                ...
                Io(
                  ...
                  function (e, a) {
                    null != n &&
                      ((r = [
                        { event: a.event, type: a.type, namespace: a.namespace, callback: n },
                      ]),
                      (i = r.length));
                    for (
                      var o = function (n) {
        ...
        var Mo = {
          ...
          Po = {
            ...
            removeListener: function (e, t, n) {
              for (var r = Oo(t), i = 0; i < this.length; i++)
        ...
        (rs.clearTraversalCache = function () {
          ...
          z(rs, {
            edgesWith: Ba(ls(), "edgesWith"),
            edgesTo: Ba(ls({ thisIsSrc: !0 }), "edgesTo"),
          }),
          z(rs, {
          ...
          (hs.restore = function () {
            ...
            for (t = 0; t < e.length; t++) {
              ...
              if (p.isEdge()) {
                for (var x = p, w = ["source", "target"], E = w.length, _ = !1, T = 0; T < E; T++) {
                  ...
                  b(N) && (N = v[D] = "" + v[D]),
                    null == N || "" === N
                      ...
                      : a.hasElementWithId(N) ||
                        (Ve(
                          "Can not create edge `" + y + "` with nonexistant " + D + " `" + N + "`",
                        ),
                        (_ = !0));
                }
                if (_) {
                ...
                A.same(L)
                  ? A._private.edges.push(x)
                  : (A._private.edges.push(x), L._private.edges.push(x)),
                  (x._private.source = A),
                  (x._private.target = L);
              }
              (g.map = new tt()),
            ...
            for (var k = 0; k < s.length; k++) {
              ...
              if (null != M || S._private.parent) {
                ...
                if (O.empty()) I.parent = void 0;
                  ...
                  P ||
                    (O[0]._private.children.push(S),
                    (S._private.parent = O[0]),
            ...
            if (e.length > 0) {
              ...
              (o.hasCompoundNodes
                ? a.collection().merge(B).merge(B.connectedNodes()).merge(B.parent())
                : B
              )
        ...
        function xs(e, t, n, r) {
          ...
          if (!o.easingImpl)
            if (null == s) o.easingImpl = vs.linear;
              ...
              (c = f(s) ? u.parse("transition-timing-function", s).value : s),
                ...
                d.length > 0
                  ? ("spring" === h && d.push(o.duration), (o.easingImpl = vs[h].apply(null, d)))
                  : (o.easingImpl = vs[h]);
            }
          var p,
            g = o.easingImpl;
          if (
            ...
            if (y && i && !e.locked()) {
              var m = {};
              ws(v.x, y.x) && (m.x = bs(v.x, y.x, p, g)),
                ws(v.y, y.y) && (m.y = bs(v.y, y.y, p, g)),
                e.position(m);
            }
            var b = o.startPan,
              x = o.pan,
              ...
              E = null != x && r;
            E &&
              (ws(b.x, x.x) && (w.x = bs(b.x, x.x, p, g)),
              ws(b.y, x.y) && (w.y = bs(b.y, x.y, p, g)),
              e.emit("pan"));
            var _ = o.startZoom,
              T = o.zoom,
              D = null != T && r;
            D && (ws(_, T) && (a.zoom = Mt(a.minZoom, bs(_, T, p, g), a.maxZoom)), e.emit("zoom")),
              (E || D) && e.emit("viewport");
            var C = o.style;
            if (C && C.length > 0 && i) {
          ...
          layout: function (e) {
            ...
            if (null != e)
              if (null != e.name) {
                ...
                if (null != i)
                  return (
                    (n = f(e.eles) ? t.$(e.eles) : null != e.eles ? e.eles : t.$()),
                    new i(z({}, e, { cy: t, eles: n }))
                  );
                Ve(
                  "No such layout `" +
                    r +
          ...
          collection: function (e, t) {
            return f(e)
              ...
              : w(e)
                ? e.collection()
                : y(e)
                  ? (t || (t = {}), new cs(this, e, t.unique, t.removed))
                  : new cs(this);
          },
          nodes: function (e) {
        ...
        (Os.apply = function (e) {
            ...
            for (
              ...
              if (null != x) {
                var w = this.properties[b],
                  ...
                  T = void 0;
                null != w.hashOverride
                  ? (T = w.hashOverride(e, x))
                  : null != x.pfValue && (T = x.pfValue);
                ...
                E.number && N && !E.multiple
                  ? (v(
                      -128 < (s = C ? T : D) && s < 128 && Math.floor(s) !== s
                        ? 2e9 - ((1024 * s) | 0)
                        : s,
                      _,
                    ),
          ...
          (Os.applyParsedProperty = function (e, t) {
            ...
            if (i.deleteBypassed)
              return u ? !!u.bypass && ((u.bypassed = void 0), g(), !0) : (g(), !0);
            if (i.deleteBypass)
              return u ? !!u.bypass && ((a[i.name] = u.bypassed), g(), !0) : (g(), !0);
            var f = function () {
              je(
            ...
            switch (i.mapped) {
              case o.mapData:
                for (var v, y = i.field.split("."), m = h.data, x = 0; x < y.length && m; x++)
                  m = m[y[x]];
                ...
                if (
                  ((v = 0 === w ? 0 : (m - i.fieldMin) / w) < 0 ? (v = 0) : v > 1 && (v = 1),
                  s.color)
                ) {
                  var E = i.valueMin[0],
                    _ = i.valueMax[0],
                ...
                break;
              case o.data:
                for (var I = i.field.split("."), M = h.data, O = 0; O < I.length && M; O++)
                  M = M[I[O]];
          ...
          Fs = {
            ...
            getAnimationStartStyle: function (e, t) {
              for (var n = {}, r = 0; r < t.length; r++) {
                var i = t[r].name,
                  a = e.pstyle(i);
                void 0 !== a && (a = m(a) ? this.parse(i, a.strValue) : this.parse(i, a)),
                  a && (n[i] = a);
              }
              return n;
            },
                ...
                if (((r = t[s]), null != (i = e.pstyle(r, !1))))
                  if (null != i.pfValue) (u[0] = Ae(o, u[0])), (u[1] = Le(o, u[1]));
                    ...
                    for (a = i.strValue, l = 0; l < a.length; l++)
                      (o = a.charCodeAt(l)), (u[0] = Ae(o, u[0])), (u[1] = Le(o, u[1]));
              return u;
            },
          };
          ...
          Gs = {
            appendFromString: function (e) {
              ...
              for (a = a.replace(/[/][*](\s|.)+?[*][/]/g, ""); !a.match(/^\s*$/); ) {
                ...
                t = l[0];
                var u = l[1];
                if ("core" !== u && new Ia(u).invalid)
                  je(
                    "Skipping parsing of block: Invalid selector found in string stylesheet: " + u,
                  ),
                    o();
                else {
                  var c = l[2],
        ...
        (function () {
          ...
          var o = {
              zeroNonZero: function (e, t) {
                return (
                  ((null == e || null == t) && e !== t) || (0 == e && 0 != t) || (0 != e && 0 == t)
                );
              },
              any: function (e, t) {
                return e != t;
        ...
        var Xs = {
            parse: function (e, t, n, r) {
              ...
              return (
                ...
                (n || "mapping" === r) && (a = qe(a)) && (a.value = qe(a.value)),
                a
              );
            },
            ...
            parseImpl: function (e, t, n, r) {
              ...
              if (h.multiple && "multiple" !== r) {
                var E;
                if (
                  ((E = l ? t.split(/\s+/) : y(t) ? t : [t]), h.evenMultiple && E.length % 2 != 0)
                )
                  return null;
              ...
              if (h.number) {
                var P,
                  R = "px";
                if (
                  (h.units && (P = h.units), h.implicitUnits && (R = h.implicitUnits), !h.unitless)
                )
                  if (l) {
                ...
                return (
                  h.unitless || ("px" !== P && "em" !== P)
                    ? (z.pfValue = t)
                    : (z.pfValue = "px" !== P && P ? this.getEmSizeInPixels() * t : t),
                  ("ms" !== P && "s" !== P) || (z.pfValue = "ms" === P ? t : 1e3 * t),
                  ("deg" !== P && "rad" !== P) ||
                    (z.pfValue = "rad" === P ? t : ((S = t), (Math.PI * S) / 180)),
                  "%" === P && (z.pfValue = t / 100),
                  z
                );
              }
              if (h.propList) {
                ...
                return {
                  name: e,
                  value: Y,
                  strValue: 0 === Y.length ? "none" : Y.join(" "),
                  bypass: n,
                };
              }
              if (h.color) {
              ...
              if (h.regex || h.regexes) {
                ...
                for (var W = h.regexes ? h.regexes : [h.regex], $ = 0; $ < W.length; $++) {
                  ...
                  if (K)
                    return {
                      name: e,
                      value: h.singleRegexMatchValue ? K[1] : K,
                      strValue: "" + t,
                      bypass: n,
                    };
                }
        ...
        (Us.instanceString = function () {
          ...
          (Us.selector = function (e) {
            var t = "core" === e ? null : new Ia(e),
              n = this.length++;
            return (
              (this[n] = { selector: t, properties: [], mappedProperties: [], index: n }), this
            );
          }),
          (Us.css = function () {
            var e = arguments;
          ...
          qs = {
            ...
            viewport: function (e) {
              ...
              if (r && (!a || !e.cancelOnFailedZoom) && t.panningEnabled) {
                var l = e.pan;
                b(l.x) && ((t.pan.x = l.x), (o = !1)),
                  b(l.y) && ((t.pan.y = l.y), (o = !1)),
                  o || i.push("pan");
              }
              return (
                i.length > 0 &&
        ...
        (qs.centre = qs.center),
          (qs.autolockNodes = qs.autolock),
          (qs.autoungrabifyNodes = qs.autoungrabify);
        var Hs = {
          data: Wi.data({
            field: "data",
            bindingEvent: "data",
        ...
        el.prototype.run = function () {
          ...
          var G = {},
            Y = function (e) {
              ...
              for (
                var t = Qs(e).depth, n = e.neighborhood(), r = 0, i = 0, o = 0;
                o < n.length;
                o++
              ) {
                var s = n[o];
            ...
            i.nodes().layoutPositions(this, n, function (e) {
              ...
              if (((l = Math.max(l, O)), n.circle)) {
                ...
                return (
                  ...
                  { x: W + c * Math.cos(h), y: $ + c * Math.sin(h) }
                );
              }
        ...
        nl.prototype.run = function () {
          ...
          if (
            ((o = b(t.radius) ? t.radius : a.length <= 1 ? 0 : Math.min(s.h, s.w) / 2 - c),
        ...
        (sl.prototype.run = function () {
          ...
          (sl.prototype.stop = function () {
            return (
              (this.stopped = !0), this.thread && this.thread.stop(), this.emit("layoutstop"), this
            );
          }),
        ...
        var ll = function (e, t, n) {
            for (
              var r = n.eles.edges(),
                i = n.eles.nodes(),
                a = Ot(
                  n.boundingBox ? n.boundingBox : { x1: 0, y1: 0, w: e.width(), h: e.height() },
                ),
                o = {
            ...
            for (u = 0; u < o.edgeSize; u++) {
              ...
              if (o.indexToGraph[L] != o.indexToGraph[k]) {
                for (
                  var S = ul(C.sourceId, C.targetId, o),
                    I = o.graphSet[S],
                    M = 0,
                    O = o.layoutNodes[L];
                  -1 === I.indexOf(O.id);
                ...
                for (O = o.layoutNodes[k]; -1 === I.indexOf(O.id); )
                  (O = o.layoutNodes[o.idToIndex[O.parentId]]), M++;
                N *= M * n.nestingFactor;
              }
            ...
            for (i = 0; i < r.length; i++) {
              ...
              if ((f = r[i])) {
                for (l = 0; l < f.length; l++)
                  (u = f[l]).isLocked || ((u.positionX += c - f.x1), (u.positionY += h - f.y1));
              ...
              function m(n) {
                ...
                if (
                  ...
                  for (var x = a.allpts, w = 0; w + 3 < x.length; w += 2)
                    if (
                      Vt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], f) &&
                      g > (r = qt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3]))
                    )
                      return v(n, r), !0;
                } else if (
                  "bezier" === a.edgeType ||
                ...
                for (w = 0; w < _.length; w++) {
                  ...
                  if (
                    D.roughCollide(e, t, E, T.angle, { x: T.x, y: T.y }, C, d) &&
              ...
              for (
                ...
                if (d.isNode()) {
                  ...
                  if (
                    ...
                    for (
                      var m = v.rstyle.bezierPts || v.rstyle.linePts || v.rstyle.haystackPts,
                        b = !0,
                        x = 0;
                      x < m.length;
                      x++
          ...
          Yl = {
            calculateArrowAngles: function (e) {
              ...
              if (
                ...
                (n *= -1),
                h &&
                  (((g = s.allpts).length / 2) % 2 == 0 ||
                    ((t = -(g[(b = 2 + (m = g.length / 2 - 1))] - g[m])),
                    (n = -(g[b + 1] - g[m + 1])))),
                ...
                (t = a - St(g[N - 6], g[N - 4], g[N - 2], 0.9)),
                  (n = o - St(g[N - 5], g[N - 3], g[N - 1], 0.9));
              } else (t = a - f), (n = o - v);
        ...
        (Xl.findHaystackPoints = function (e) {
          ...
          (Xl.tryToCorrectInvalidPoints = function (e, t) {
            ...
            if ("bezier" === n.edgeType) {
              ...
              if (h || d || y) {
                ...
                y
                  ? ((n.ctrlpts[0] = n.ctrlpts[0] + T.x * (f - v)),
                    (n.ctrlpts[1] = n.ctrlpts[1] + T.y * (f - v)))
              ...
              if (p || g || x) {
                ...
                x
                  ? ((n.ctrlpts[0] = n.ctrlpts[0] + k.x * (f - m)),
                    (n.ctrlpts[1] = n.ctrlpts[1] + k.y * (f - m)))
                ...
                var y = function (e) {
                    ...
                    for (var _ = 0; _ < s.eles.length; _++) {
                      ...
                      if (!s.calculatedIntersection && h !== d && (s.hasBezier || s.hasUnbundled)) {
                        ...
                        (s.nodesOverlap =
                          !b(B) ||
                          E.checkPoint(L[0], L[1], 0, m, x, f.x, f.y) ||
                          w.checkPoint(S[0], S[1], 0, v, y, g.x, g.y)),
          ...
          (Xl.getControlPoints = function (e) {
            ...
            if ("bezier" === n || "multibezier" === n || "self" === n || "compound" === n)
              return this.recalculateRenderedStyle(e), Vl(t.ctrlpts);
          }),
        ...
        var Ul = {
            ...
            findEndpoints: function (e) {
              ...
              if (((v.srcManEndpt = C), (v.tgtManEndpt = A), x)) {
                ...
                (n = w ? [v.ctrlpts[v.ctrlpts.length - 2], v.ctrlpts[v.ctrlpts.length - 1]] : k),
                  (r = k);
              } else if (E) {
              ...
              if ("inside-to-node" === L) t = [c.x, c.y];
                ...
                var Y = tn(
                  i[0],
                  i[1],
                  [P - B, R - F, P + B, R - F, P + B, R + F, P - B, R + F],
                  c.x,
                  c.y,
                );
                if (Y.length > 0) {
                  var X = u,
                    ...
                    j = V;
                  U < V && ((t = Y), (j = U)),
                    Y.length > 2 && Lt(X, { x: Y[2], y: Y[3] }) < j && (t = [Y[2], Y[3]]);
                }
              }
              ...
              if (
                ...
                if (re.length > 0) {
                  var ie = c,
                    ...
                    oe = Lt(ie, Tt(re)),
                    se = ae;
                  oe < ae && ((t = [re[0], re[1]]), (se = oe)),
                    re.length > 2 && Lt(ie, { x: re[2], y: re[3] }) < se && (t = [re[2], re[3]]);
                }
              }
              ...
              (v.startX = ue[0]),
                ...
                (v.arrowStartY = le[1]),
                T &&
                  (b(v.startX) && b(v.startY) && b(v.endX) && b(v.endY)
                    ? (v.badLine = !1)
                    : (v.badLine = !0));
            },
                  ...
                  switch (r.edgeType) {
                    ...
                    case "haystack":
                      for (
                        ...
                        k + 3 < L &&
                        (s
                          ? ((C = { x: r.allpts[k], y: r.allpts[k + 1] }),
                            (N = { x: r.allpts[k + 2], y: r.allpts[k + 3] }))
                          : ((C = { x: r.allpts[L - 2 - k], y: r.allpts[L - 1 - k] }),
                            (N = { x: r.allpts[L - 4 - k], y: r.allpts[L - 3 - k] })),
                        (D = A),
                        !((A += T = At(C, N)) >= u));
                        k += 2
                      );
          ...
          (Hl.getLabelText = function (e, t) {
            ...
            if ("wrap" === s) {
              ...
              for (
                ...
                if (y > c) {
                  for (var b = v.split(p), x = "", w = 0; w < b.length; w++) {
                    ...
                    this.calculateLabelDimensions(e, _).width <= c
                      ? (x += E + g)
                      : (x && d.push(x), (x = E + g));
                  }
                  x.match(/^[\s\u200b]+$/) || d.push(x);
              ...
              o("labelWrapCachedLines", d),
                (i = o("labelWrapCachedText", d.join("\n"))),
                o("labelWrapKey", l);
            } else if ("ellipsis" === s) {
              ...
              for (
                var N = 0;
                N < i.length && !(this.calculateLabelDimensions(e, D + i[N] + "…").width > T);
                N++
              )
                  ...
                  function (t) {
                    if (e.hoverData.capture || E(t)) {
                      ...
                      e.hoverData.draggingEles ||
                        ...
                        (f = e.findNearestElement(c[0], c[1], !0, !1));
                      var v,
                        y = e.hoverData.last,
                        m = e.hoverData.down,
                        x = [c[0] - g[2], c[1] - g[3]],
                      ...
                      (n = !0),
                        r(f, ["mousemove", "vmousemove", "tapdrag"], t, { x: c[0], y: c[1] });
                      var A = function () {
                      ...
                      if (3 === e.hoverData.which) {
                          ...
                          if (v) {
                            if (o.boxSelectionEnabled() && N)
                              m &&
                                ...
                                m.emit("freeon"),
                                w.emit("free"),
                                e.dragData.didDrag && (m.emit("dragfreeon"), w.emit("dragfree"))),
                                A();
                              ...
                              (e.hoverData.draggingEles = !0),
                                w.silentShift(M).emit("position drag"),
                                e.redrawHint("drag", !0),
                                e.redraw();
                            }
                          } else
                        ...
                        v &&
                          ...
                          (!N && o.panningEnabled() && o.userPanningEnabled())
                            ? !e.hoverData.selecting &&
                              o.panningEnabled() &&
                  ...
                  (B = function (t) {
                    if (((e.hasTouchStarted = !0), E(t))) {
                      ...
                      if (
                        ...
                        (N = U(_, T, D, C)),
                          (A = j(_, T, D, C)),
                          (k = [((L = [(_ + D) / 2, (T + C) / 2])[0] - d.x) / g, (L[1] - d.y) / g]);
                      ...
                      if (t.touches.length >= 1) {
                        for (
                          var R = (e.touchData.startPosition = [
                              null,
                              null,
                              null,
                              null,
                    ...
                    if (n || E(t)) {
                      ...
                      if (n && e.touchData.cxt) {
                        ...
                        if (R / A >= 2.25 || R >= 22500) {
                          ...
                          e.touchData.start
                            ? (e.touchData.start.unactivate().emit(B), (e.touchData.start = null))
                            : o.emit(B);
                        }
                      }
                      if (n && e.touchData.cxt) {
                        ...
                        if (
                          (r(te || F, ["touchmove", "tapdrag", "vmousemove"], t, {
                            x: s[0],
                            y: s[1],
                          }),
                          (te && te.grabbed()) ||
                        ...
                        n &&
                          ...
                          (a(te, e.touchData.starts) &&
                            ...
                            e.data.bgActivePosistion ||
                              (e.data.bgActivePosistion = Tt(e.touchData.startPosition)),
                            e.swipePanning
                        ...
                        if (null != i) {
                          ...
                          h(f),
                            ...
                            v &&
                              (i.emit("freeon"),
                              f.emit("free"),
                              e.dragData.didDrag && (i.emit("dragfreeon"), f.emit("dragfree"))),
                ...
                var q = [],
                  ...
                  $ = function (e) {
                    for (var t = 0; t < q.length; t++)
                      if (q[t].event.pointerId === e.pointerId) return void q.splice(t, 1);
                  },
                  K = function (e) {
                  ...
                  return (function (e, t, n, r, i, a, o, s) {
                    for (
                      ...
                      D * n[v] + C * n[v + 1] < 0 && ((D *= -1), (C *= -1)),
                        0 !== (l = Qt(e, t, r, i, w + D * p, E + C * p, p)).length &&
                          u.push(l[0], l[1]);
                    }
                    for (var N = 0; N < c.length / 4; N++)
                      0 !==
                        (l = en(e, t, r, i, c[4 * N], c[4 * N + 1], c[4 * N + 2], c[4 * N + 3], !1))
                          .length && u.push(l[0], l[1]);
                    if (u.length > 2) {
                      for (
                        var A = [u[0], u[1]],
                          L = Math.pow(A[0] - e, 2) + Math.pow(A[1] - t, 2),
                          k = 1;
                        k < u.length / 2;
                        k++
                      ) {
              ...
              return (this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle =
                {
                  ...
                  checkPoint: function (e, t, n, r, i, a, o) {
                    if (Wt(e, t, this.points, a, o, r, i - 2 * this.cornerLength, [0, -1], n))
                      return !0;
                    if (Wt(e, t, this.points, a, o, r - 2 * this.cornerLength, i, [0, -1], n))
                      return !0;
                    var s = this.generateCutTrianglePts(r, i, a, o);
                    return (
                      Ht(e, t, s.topLeft) ||
                      Ht(e, t, s.topRight) ||
                      Ht(e, t, s.bottomRight) ||
                      Ht(e, t, s.bottomLeft)
                    );
                  },
                });
        ...
        (ou.clientFunctions = [
          ...
          (ou.init = function (e) {
            ...
            if (r) {
              ...
              if (
                (n.className.indexOf(s) < 0 && (n.className = (n.className || "") + " " + s), !l)
              ) {
        ...
        (pu.reasons = cu),
          (pu.getTextureQueue = function (e) {
            var t = this;
            return (
              (t.eleImgCaches = t.eleImgCaches || {}), (t.eleImgCaches[e] = t.eleImgCaches[e] || [])
            );
          }),
          ...
          (pu.getElement = function (e, t, n, r, i) {
            ...
            if (
              ...
              return g;
            if (((p = c <= 25 ? 25 : c <= 50 ? 50 : 50 * Math.ceil(c / 50)), c > 1024 || h > 1024))
              return null;
          ...
          (pu.removeFromQueue = function (e) {
            ...
            null != i &&
              (1 === i.eles.length
                ? ((i.reqs = Fe), t.updateItem(i), t.pop(), (n[r] = null))
                : i.eles.unmerge(e));
          }),
          ...
          (fu.getLayers = function (e, t, n) {
            ...
            for (var d = null, p = e.length / 1, g = !a, f = 0; f < e.length; f++) {
              ...
              if (b) d = b;
                ...
                if (
                  (!d || d.eles.length >= p || !Yt(d.bb, v.boundingBox())) &&
                  !(d = h({ insert: !0, after: d }))
                )
                  return null;
                s || g ? r.queueLayer(d, v) : r.drawEleInLayer(d, v, n, t),
                  d.eles.push(v),
                  (m[n] = d);
              }
            }
        ...
        (Du.drawCachedElement = function (e, t, n, r, i, a) {
          ...
          if (0 !== d.w && 0 !== d.h && t.visible() && (!r || zt(d, r))) {
            ...
            o.drawElementUnderlay(e, t),
              ...
              g &&
                !f &&
                (o.drawCachedElementPortion(e, t, c, n, i, p, Au, Su),
                o.drawCachedElementPortion(e, t, h, n, i, p, Lu, Su)),
        ...
        (Iu.drawEdgeOverlay = Mu("overlay")),
          ...
          (Iu.drawArrowheads = function (e, t, n) {
            ...
            i ||
              this.drawArrowhead(e, t, "source", r.arrowStartX, r.arrowStartY, r.srcArrowAngle, n),
            ...
            if (!(isNaN(r) || null == r || isNaN(i) || null == i || isNaN(a) || null == a)) {
              ...
              if ("none" !== l) {
                ...
                s.colorFillStyle(e, g[0], g[1], g[2], o),
                  ...
                  s.drawArrowShape(t, e, c, h, l, r, i, a);
              }
            }
          }),
        ...
        var Ou = {
            ...
            drawInscribedImage: function (e, t, n, r, i) {
              ...
              if (
                ...
                if (
                  ("no" === w && F
                    ? (a.setImgSmoothing(e, !1), (z = !0))
                    : "yes" !== w || F || (a.setImgSmoothing(e, !0), (z = !0)),
                  "no-repeat" === d)
                )
                  b &&
                    (e.save(),
                    m.pathCache
                      ? e.clip(m.pathCache)
                      : (a.nodeShapes[a.getNodeShape(n)].draw(e, s, l, v, y), e.clip())),
            ...
            n && ((p = n), e.translate(-p.x1, -p.y1)),
              null == i
                ? (o.drawText(e, t, null, g, a),
                  t.isEdge() &&
                    (o.drawText(e, t, "source", g, a), o.drawText(e, t, "target", g, a)))
              ...
              if (null != h && "" !== h && !isNaN(u) && !isNaN(c)) {
                ...
                switch (
                  ...
                  0 !== (d = r ? this.getTextAngle(t, n) : 0) &&
                    ((s = u), (l = c), e.translate(s, l), e.rotate(d), (u = 0), (c = 0)),
                  x)
                ) {
                  case "top":
                    break;
                ...
                if ((R > 0 && (e.lineWidth = R), "wrap" === t.pstyle("text-wrap").value)) {
                  ...
                  for (var Y = 0; Y < B.length; Y++)
                    R > 0 && e.strokeText(B[Y], u, c), e.fillText(B[Y], u, c), (c += F);
              ...
              if (b(h.x) && b(h.y) && (!s || t.visible())) {
                ...
                if (f) {
                  ...
                  var R = (l.nodePathCache = l.nodePathCache || []),
                    ...
                    F = R[B];
                  null != F
                    ? ((d = F), (v = !0), (c.pathCache = d))
                    : ((d = new Path2D()), (R[B] = c.pathCache = d));
                }
                var z = function () {
                    if (!v) {
                      var n = h;
                    ...
                    for (
                      ...
                      (r && "over" === s) || (!r && "inside" === s)
                        ...
                        : x[o] &&
                          w[o].complete &&
                          !w[o].error &&
                          (a++, l.drawInscribedImage(e, w[o], t, o, n));
                    }
                  ...
                  Y = function () {
                    ...
                    l.hasPie(t) &&
                      (l.drawPie(e, t, a),
                      n && (f || l.nodeShapes[l.getNodeShape(t)].draw(e, h.x, h.y, r, i)));
                  },
                  X = function () {
                    var t =
                        (C > 0 ? C : -C) *
        ...
        (Fu.getPixelRatio = function () {
          ...
          (Fu.render = function (e) {
              ...
              if (((o.textureDrawLastFrame = !0), !o.textureCache)) {
                ...
                A.setTransform(1, 0, 0, 1, 0, 0),
                  ...
                  ((_ = o.textureCache.viewport =
                    ...
                    }).mpan = { x: (0 - _.pan.x) / _.zoom, y: (0 - _.pan.y) / _.zoom });
              }
            ...
            if (
              ((R[o.NODE] =
                (!c[o.NODE] && d && !o.clearedForMotionBlur[o.NODE]) || o.clearingMotionBlur),
              R[o.NODE] && (o.clearedForMotionBlur[o.NODE] = !0),
              (R[o.DRAG] =
                (!c[o.DRAG] && d && !o.clearedForMotionBlur[o.DRAG]) || o.clearingMotionBlur),
              ...
              N(
                (L =
                  t || (B ? o.data.bufferContexts[o.MOTIONBLUR_BUFFER_NODE] : u.contexts[o.NODE])),
                d && !B ? "motionBlur" : void 0,
              ),
                P
                  ? o.drawCachedNodes(L, D.nondrag, s, M)
                  : o.drawLayeredElements(L, D.nondrag, s, M),
            ...
            if (
              (!r &&
                ...
                N(
                  (L =
                    t ||
                    (B ? o.data.bufferContexts[o.MOTIONBLUR_BUFFER_DRAG] : u.contexts[o.DRAG])),
                  d && !B ? "motionBlur" : void 0,
                ),
            ...
            if (d && 1 !== p) {
              ...
              (c[o.NODE] || R[o.NODE]) && (q(X, V, R[o.NODE]), (c[o.NODE] = !1)),
                (c[o.DRAG] || R[o.DRAG]) && (q(U, j, R[o.DRAG]), (c[o.DRAG] = !1));
            }
            (o.prevViewport = _),
              o.clearingMotionBlur &&
        ...
        zu.drawEllipsePath = function (e, t, n, r, i) {
          if ((e.beginPath && e.beginPath(), e.ellipse))
            ...
            for (var a, o, s = r / 2, l = i / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Uu)
              (a = t - s * Xu[u] * Gu + s * Vu[u] * Yu),
                (o = n + l * Vu[u] * Gu + l * Xu[u] * Yu),
        ...
        (qu.createBuffer = function (e, t) {
          ...
          (qu.bufferCanvasImage = function (e) {
            ...
            if (void 0 !== e.scale) (i *= e.scale), (a *= e.scale), (l = e.scale);
              ...
              var u = 1 / 0,
                c = 1 / 0;
              b(e.maxWidth) && (u = (l * e.maxWidth) / i),
                b(e.maxHeight) && (c = (l * e.maxHeight) / a),
                (i *= l = Math.min(u, c)),
                (a *= l);
            }
            o || ((i *= s), (a *= s), (l *= s));
        ...
        function Zu(e) {
          ...
          u &&
            u.userAgent.match(/msie|trident|edge/i) &&
          ...
          for (
            t.data.topCanvas = t.data.canvases[0],
              ...
              t.data.canvases[Ku.SELECT_BOX].setAttribute(
                "data-id",
                "layer" + Ku.SELECT_BOX + "-selectbox",
              ),
        ...
        var uc = function (e) {
          return (
            void 0 === e && (e = {}), m(e) ? new Ws(e) : f(e) ? oc.apply(oc, arguments) : void 0
          );
        };
        return (
          (uc.use = function (e) {
        ...
        return (function (e) {
              ...
              (u.prototype.updateBounds = function () {
                ...
                if (0 != this.getChild().getNodes().length) {
                  ...
                  if (
                    ...
                    this.labelWidth > t &&
                      ((this.rect.x -= (this.labelWidth - t) / 2), this.setWidth(this.labelWidth)),
                      this.labelHeight > n &&
          ...
          function (e, t, n) {
            ...
            function d(e, t, n) {
              r.call(this, n),
                ...
                null != t && t instanceof o
                  ? (this.graphManager = t)
                  : null != t && t instanceof Layout && (this.graphManager = t.graphManager);
            }
            ...
            (d.prototype.getNodes = function () {
              ...
              (d.prototype.add = function (e, t, n) {
                ...
                var i = e;
                if (!(this.getNodes().indexOf(t) > -1 && this.getNodes().indexOf(n) > -1))
              ...
              (d.prototype.calcEstimatedSize = function () {
                ...
                return (
                  (this.estimatedSize =
                    0 == e ? a.EMPTY_COMPOUND_NODE_SIZE : e / Math.sqrt(this.nodes.length)),
                  this.estimatedSize
                );
              }),
          ...
          function (e, t, n) {
            ...
            (a.prototype.addRoot = function () {
              ...
              (a.prototype.add = function (e, t, n, r, i) {
                ...
                if (-1 != n.source.edges.indexOf(n) || -1 != n.target.edges.indexOf(n))
              ...
              (a.prototype.remove = function (e) {
                if (e instanceof r) {
                  ...
                  for (var n, a = [], o = (a = a.concat(t.getEdges())).length, s = 0; s < o; s++)
                    (n = a[s]), t.remove(n);
                  var l,
                    u = [];
                  for (o = (u = u.concat(t.getNodes())).length, s = 0; s < o; s++)
                    (l = u[s]), t.remove(l);
              ...
              (a.prototype.getAllNodes = function () {
                if (null == this.allNodes) {
                  for (var e = [], t = this.getGraphs(), n = t.length, r = 0; r < n; r++)
              ...
              (a.prototype.getAllEdges = function () {
                if (null == this.allEdges) {
                  for (var e = [], t = this.getGraphs(), n = (t.length, 0); n < t.length; n++)
              ...
              (a.prototype.setRootGraph = function (e) {
                ...
                (this.rootGraph = e),
                  null == e.parent && (e.parent = this.layout.newNode("Root node"));
              }),
                ...
                for (var e, t, n, r, i, a = this.getAllEdges(), o = a.length, s = 0; s < o; s++)
                  if (
                    ...
                    for (r = t.getOwner(); null == e.lca; ) {
                      ...
                      null == e.lca &&
                        ((e.sourceInLca = r.getParent()), (r = e.sourceInLca.getOwner()));
                    }
                    if (null == e.lca) throw "assert failed";
              ...
              (a.prototype.calcInclusionTreeDepths = function (e, t) {
                ...
                for (var r = e.getNodes(), i = r.length, a = 0; a < i; a++)
                  ((n = r[a]).inclusionTreeDepth = t),
                    null != n.child && this.calcInclusionTreeDepths(n.child, t + 1);
              }),
              (a.prototype.includesInvalidEdge = function () {
                for (var e, t = this.edges.length, n = 0; n < t; n++)
                  if (((e = this.edges[n]), this.isOneAncestorOfOther(e.source, e.target)))
                    return !0;
                return !1;
              }),
              (e.exports = a);
              ...
              this.decideDirectionsForOverlappingNodes(e, t, i),
                ...
                e.getY() <= t.getY() && e.getBottom() >= t.getBottom()
                  ...
                  : t.getY() <= e.getY() &&
                    ...
                    (n[1] += Math.min(e.getY() - t.getY(), t.getBottom() - e.getBottom()));
              var a = Math.abs(
                (t.getCenterY() - e.getCenterY()) / (t.getCenterX() - e.getCenterX()),
              );
            ...
            (i.lastID = 0),
              (i.createID = function (e) {
                return i.isPrimitive(e)
                  ? e
                  : (null != e.uniqueID || ((e.uniqueID = i.getString()), i.lastID++), e.uniqueID);
              }),
            ...
            (d.RANDOM_SEED = 1),
              ...
              (d.prototype.update = function (e) {
                if (null == e) this.update2();
                  ...
                  var t = e;
                  if (null != t.getChild())
                    for (var n = t.getChild().getNodes(), r = 0; r < n.length; r++) update(n[r]);
              ...
              (d.prototype.positionNodesRandomly = function (e) {
                if (null == e)
                  ...
                  for (var t, n, r = e.getNodes(), i = 0; i < r.length; i++)
                    null == (n = (t = r[i]).getChild()) || 0 == n.getNodes().length
                      ? t.scatter()
                      : (this.positionNodesRandomly(n), t.updateBounds());
              }),
              (d.prototype.getFlatForest = function () {
                for (
                  var e = [], t = !0, n = this.graphManager.getRoot().getNodes(), i = !0, a = 0;
                  a < n.length;
                  a++
                )
              ...
              (d.prototype.createDummyNodesForBendpoints = function (e) {
                for (
                  var t = [],
                    n = e.source,
                    r = this.graphManager.calcLowestCommonAncestor(e.source, e.target),
                    i = 0;
            ...
            (i.prototype.getWorldOrgX = function () {
              ...
              (i.prototype.transformX = function (e) {
                var t = 0,
                  n = this.lworldExtX;
                return (
                  0 != n && (t = this.ldeviceOrgX + ((e - this.lworldOrgX) * this.ldeviceExtX) / n),
                  t
                );
              }),
              (i.prototype.transformY = function (e) {
                var t = 0,
                  n = this.lworldExtY;
                return (
                  0 != n && (t = this.ldeviceOrgY + ((e - this.lworldOrgY) * this.ldeviceExtY) / n),
                  t
                );
              }),
              (i.prototype.inverseTransformX = function (e) {
                var t = 0,
                  n = this.ldeviceExtX;
                return (
                  0 != n && (t = this.lworldOrgX + ((e - this.ldeviceOrgX) * this.lworldExtX) / n),
                  t
                );
              }),
              (i.prototype.inverseTransformY = function (e) {
                var t = 0,
                  n = this.ldeviceExtY;
                return (
                  0 != n && (t = this.lworldOrgY + ((e - this.ldeviceOrgY) * this.lworldExtY) / n),
                  t
                );
              }),
          ...
          function (e, t, n) {
            ...
            (l.prototype.initParameters = function () {
              ...
              (l.prototype.calcIdealEdgeLengths = function () {
                for (
                  var e, t, n, r, o, s, l = this.getGraphManager().getAllEdges(), u = 0;
                  u < l.length;
                  u++
                )
                ...
                this.incremental
                  ? (e > i.ADAPTATION_LOWER_NODE_LIMIT &&
                      (this.coolingFactor = Math.max(
                        ...
                        this.coolingFactor -
                          ((e - i.ADAPTATION_LOWER_NODE_LIMIT) /
                            (i.ADAPTATION_UPPER_NODE_LIMIT - i.ADAPTATION_LOWER_NODE_LIMIT)) *
                            this.coolingFactor *
                ...
                if (this.useFRGridVariant)
                  ...
                  for (e = 0; e < l.length; e++)
                    for (n = l[e], t = e + 1; t < l.length; t++)
                      (r = l[t]), n.getOwner() == r.getOwner() && this.calcRepulsionForce(n, r);
              }),
              (l.prototype.calcGravitationalForces = function () {
                for (var e, t = this.getAllNodesToApplyGravitation(), n = 0; n < t.length; n++)
              ...
              (l.prototype.calcSpringForce = function (e, t) {
                var n,
                  ...
                  o = e.getSource(),
                  s = e.getTarget();
                if (this.uniformLeafNodeSizes && null == o.getChild() && null == s.getChild())
              ...
              (l.prototype.calcRepulsionForce = function (e, t) {
                ...
                if (d.intersects(p)) {
                  ...
                  this.uniformLeafNodeSizes && null == e.getChild() && null == t.getChild()
                    ...
                    (l = Math.sqrt(a)),
                    (c =
                      ((u = (this.repulsionConstant * e.noOfChildren * t.noOfChildren) / a) * n) /
                      l),
                    (h = (u * r) / l),
                    (e.repulsionForceX -= c),
                    (e.repulsionForceY -= h),
                ...
                (n = ((t = e.getOwner()).getRight() + t.getLeft()) / 2),
                  ...
                  e.getOwner() == this.graphManager.getRoot()
                    ...
                    : (o > (l = t.getEstimatedSize() * this.compoundGravityRangeFactor) || s > l) &&
                      ...
                      (e.gravitationForceY =
                        -this.gravityConstant * a * this.compoundGravityConstant));
              }),
              ...
              (l.prototype.calcNoOfChildrenForAllNodes = function () {
                for (var e, t = this.graphManager.getAllNodes(), n = 0; n < t.length; n++)
              ...
              (l.prototype.addNodeToGrid = function (e, t, n) {
                ...
                (r = parseInt(Math.floor((e.getRect().x - t) / this.repulsionRange))),
                  (i = parseInt(
                    Math.floor((e.getRect().width + e.getRect().x - t) / this.repulsionRange),
                  )),
                  (a = parseInt(Math.floor((e.getRect().y - n) / this.repulsionRange))),
                  (o = parseInt(
                    Math.floor((e.getRect().height + e.getRect().y - n) / this.repulsionRange),
                  ));
                for (var s = r; s <= i; s++)
                  for (var l = a; l <= o; l++)
                    ...
                    for (var u = e.startY - 1; u < e.finishY + 2; u++)
                      if (!(l < 0 || u < 0 || l >= s.length || u >= s[0].length))
                        for (var c = 0; c < s[l][u].length; c++)
                          if (
                            ((a = s[l][u][c]),
                            e.getOwner() == a.getOwner() && e != a && !t.has(a) && !o.has(a))
                          ) {
                            var h =
          ...
          function (e, t, n) {
            ...
            function r(e, t) {
              (this.width = 0),
                (this.height = 0),
                null !== e && null !== t && ((this.height = t), (this.width = e));
            }
            (r.prototype.getWidth = function () {
              return this.width;
            }),
          ...
          function (e, t, n) {
            ...
            (i.prototype.add = function (e) {
              ...
              (i.prototype.addAllTo = function (e) {
                for (var t = Object.keys(this.set), n = t.length, r = 0; r < n; r++)
                  e.push(this.set[t[r]]);
              }),
              (i.prototype.size = function () {
                return Object.keys(this.set).length;
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (var t = 1; t < this.iMax; t++)
                          (this.grid[t][0] = this.grid[t - 1][0] + this.gap_penalty),
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          n[0] &&
                            ...
                            0 === t.pos[0] &&
                              0 === t.pos[1] &&
                              this.alignments.push({ sequence1: t.seq1, sequence2: t.seq2 }),
                            e.shift();
                        }
                        return this.alignments;
                      },
    ...
    4662: function (e, t, n) {
              ...
              m = {
                ...
                performAction: function (e, t, n, r) {
                  switch (n) {
                    ...
                    case 29:
                      return (
                        this.popState(), e.getLogger().trace("node end ...", t.yytext), "NODE_DEND"
                      );
                    case 30:
                    case 33:
                    case 34:
          ...
          Object.defineProperty(
            {
              ...
              addNode: (e, t, n, i) => {
                ...
                const a = (0, r.c)(),
                  o = {
                    ...
                    type: i,
                    children: [],
                    width: (0, r.c)().mindmap.maxNodeWidth,
                  };
                switch (o.type) {
                  case y.ROUNDED_RECT:
                  case y.RECT:
                ...
                const s = (function (e) {
                  for (let t = g.length - 1; t >= 0; t--) if (g[t].level < e) return g[t];
                  return null;
                })(e);
                if (s) s.children.push(o), g.push(o);
                else {
                  if (0 !== g.length) {
                    let e = new Error(
              ...
              decorateNode: (e) => {
                ...
                e && e.icon && (t.icon = p(e.icon)), e && e.class && (t.class = p(e.class));
              },
              getElementById: w,
              getLogger: () => r.l,
              getMindmap: () => (g.length > 0 ? g[0] : null),
              getNodeById: (e) => g[e],
              getType: (e, t) => {
                switch ((r.l.debug("In get type", e, t), e)) {
                  case "[":
                    return y.RECT;
                  case "(":
                    return ")" === t ? y.ROUNDED_RECT : y.CLOUD;
                  case "((":
                    return y.CIRCLE;
                  case ")":
                    return y.CLOUD;
      ...
      function _(e, t, n, r) {
        (function (e, t, n, r) {
          ...
          (0, a.c)(c, h, { useHtmlLabels: i, width: t.width, classes: "mindmap-node-label" }),
            i ||
              c
                .attr("dy", "1em")
          ...
          if (
            ((t.height = d.height + 1.1 * p * 0.5 + t.padding),
            (t.width = d.width + 2 * t.padding),
            t.icon)
          )
            if (t.type === y.CIRCLE)
              (t.height += 50),
              ...
              s
                ...
                c.attr(
                  "transform",
                  "translate(" + (25 + t.width / 2) + ", " + (n / 2 + t.padding / 2) + ")",
                );
            }
          else if (i) {
            ...
            case y.DEFAULT:
              !(function (e, t, n) {
                e
                  .append("path")
                  .attr("id", "node-" + t.id)
                  .attr("class", "node-bkg node-" + b(t.type))
                  .attr(
                    "d",
                    `M0 ${t.height - 5} v${10 - t.height} q0,-5 5,-5 h${t.width - 10} q5,0 5,5 v${t.height - 5} H0 Z`,
                  ),
                  e
                    .append("line")
      ...
      function D(e, t) {
        return new Promise((n) => {
          ...
          a.remove(),
            ...
            s
              .layout({ name: "cose-bilkent", quality: "proof", styleEnabled: !1, animate: !1 })
              .run(),
            s.ready((e) => {
      ...
      const C = {
        ...
        renderer: {
          draw: async (e, t, n, a) => {
            ...
            const u = (
              "sandbox" === s ? (0, i.Ys)(l.nodes()[0].contentDocument.body) : (0, i.Ys)("body")
            ).select("#" + t);
            u.append("g");
            ...
            const d = u.append("g");
            d.attr("class", "mindmap-nodes"), _(d, c, -1, o);
            const p = await D(c, o);
            !(function (e, t) {
              t.edges().map((t, n) => {
                const i = t.data();
              ...
              (0, r.p)(void 0, u, o.mindmap.padding, o.mindmap.useMaxWidth);
          },
        },
        parser: d,
        styles: (e) =>
          `\n  .edge {\n    stroke-width: 3;\n  }\n  ${((e) => {
            ...
            for (let t = 0; t < e.THEME_COLOR_LIMIT; t++)
              (e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t]),
                (0, l.Z)(e["lineColor" + t])
                  ? (e["lineColor" + t] = (0, u.Z)(e["lineColor" + t], 20))
                  : (e["lineColor" + t] = (0, c.Z)(e["lineColor" + t], 20));
