              ...
              n = {
                ...
                parse: function (t) {
                  ...
                  for (var u in this.yy)
                    Object.prototype.hasOwnProperty.call(this.yy, u) && (y.yy[u] = this.yy[u]);
                  a.setInput(t, y.yy),
                    (y.yy.lexer = a),
                    (y.yy.parser = this),
                  ...
                  for (var g, _, m, d, k, x, b, v, w, I = {}; ; ) {
                    if (
                      ...
                      var S;
                      for (k in ((v = []), r[_]))
                        this.terminals_[k] && k > 2 && v.push("'" + this.terminals_[k] + "'");
                      (S = a.showPosition
                        ? "Parse error on line " +
                          (o + 1) +
                          ":\n" +
                ...
                unput: function (t) {
                  ...
                  return (
                    (this.yylloc = {
                      ...
                      last_column: n
                        ? (n.length === e.length ? this.yylloc.first_column : 0) +
                          e[e.length - n.length].length -
                          n[0].length
