...
- **System properties**: Use the command line parameter `-Dio.prometheus.exporter.http_server.port=9401`
...
For backward compatibility, camelCase property names are also supported in properties files and system properties,
but snake_case is the preferred format.
...
| --------------------------------------------- | ------------------------------------------ |
| `IO_PROMETHEUS_EXEMPLARS_ENABLED`             | `io.prometheus.exemplars.enabled`          |
