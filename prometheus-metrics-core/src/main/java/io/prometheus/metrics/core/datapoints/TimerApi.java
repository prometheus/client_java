 ...
 *
 * <p>Durations are recorded in seconds. The Prometheus instrumentation guidelines <a
 * href="https://prometheus.io/docs/instrumenting/writing_exporters/#naming">say</a>: <i>"Metrics
...
public interface TimerApi {
   ...
   * }</pre>
   *
   * Durations are recorded in seconds. The Prometheus instrumentation guidelines <a
   * href="https://prometheus.io/docs/instrumenting/writing_exporters/#naming">say</a>: <i>"Metrics
