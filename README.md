...
`SummaryMetricFamily` work similarly. The histogram metric is complicated so a `HistogramMetricFamily` helper would do basically nothing to reduce code complexity, thus it was not included.
