...
class ExpositionFormatsTest {
  ...
  private final String exemplar2String =
      "{env=\"dev\",span_id=\"23456\",trace_id=\"bcdef\"} 2.4 1672850685.830";
  private final String exemplarWithDotsString =
      "{some_exemplar_key=\"some value\"} 3.0 1690298864.383";

  private final String exemplar1protoString =
      "exemplar { "
  ...
  private final String exemplar2protoString =
      "exemplar { "
  ...
  private final String exemplarWithDotsProtoString =
      "exemplar { "
  ...
  private final Exemplar exemplar1 =
      Exemplar.builder()
          .spanId("12345")
          .traceId("abcde")
  ...
  private final Exemplar exemplarWithDots =
      Exemplar.builder()
        ...
        CounterSnapshot.builder()
            ...
            .dataPoint(
                CounterDataPointSnapshot.builder()
                    .value(0.8)
                    .labels(Labels.builder().label("path", "/hello").label("status", "200").build())
                    .exemplar(exemplar1)
            ...
            .dataPoint(
                CounterDataPointSnapshot.builder()
                    .value(0.9)
                    .labels(Labels.builder().label("path", "/hello").label("status", "500").build())
                    .exemplar(exemplar2)
  ...
  void testGaugeComplete() throws IOException {
    String openMetricsText =
        "# TYPE disk_usage_ratio gauge\n"
            ...
            + "disk_usage_ratio{device=\"/dev/sda1\"} 0.2 "
            + scrapeTimestamp1s
            + "\n"
            + "disk_usage_ratio{device=\"/dev/sda2\"} 0.7 "
            + scrapeTimestamp2s
            + "\n"
            + "# EOF\n";
        ...
        GaugeSnapshot.builder()
            ...
            .dataPoint(
                GaugeDataPointSnapshot.builder()
                    .value(0.7)
                    .labels(Labels.builder().label("device", "/dev/sda2").build())
                    .exemplar(exemplar2)
                    .scrapeTimestampMillis(scrapeTimestamp2)
                    .build())
            .dataPoint(
                GaugeDataPointSnapshot.builder()
                    .value(0.2)
                    .labels(Labels.builder().label("device", "/dev/sda1").build())
                    .exemplar(exemplar1)
                    .scrapeTimestampMillis(scrapeTimestamp1)
                    .build())
            .build();
  ...
  void testGaugeMinimal() throws IOException {
    ...
    GaugeSnapshot gauge =
        GaugeSnapshot.builder()
            ...
            .dataPoint(GaugeDataPointSnapshot.builder().value(22.3).build())
            .build();
    assertOpenMetricsText(openMetricsText, gauge);
    assertPrometheusText(prometheusText, gauge);
    assertOpenMetricsTextWithoutCreated(openMetricsText, gauge);
    ...
    GaugeSnapshot gauge =
        GaugeSnapshot.builder()
            ...
            .dataPoint(
                GaugeDataPointSnapshot.builder()
                    .value(23.0)
                    .labels(Labels.builder().label("location.id", "data-center-1").build())
                    .exemplar(exemplarWithDots)
                    .build())
            .build();
    assertOpenMetricsText(openMetricsText, gauge);
  ...
  void testSummaryComplete() throws IOException {
    String openMetricsText =
        "# TYPE http_request_duration_seconds summary\n"
            ...
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds{status=\"200\",quantile=\"0.9\"} 240.7 "
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds{status=\"200\",quantile=\"0.95\"} 245.1 "
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds_count{status=\"200\"} 3 "
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds_sum{status=\"200\"} 1.2 "
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds_created{status=\"200\"} "
            + createdTimestamp1s
            + " "
            + scrapeTimestamp1s
            + "\n"
            + "http_request_duration_seconds{status=\"500\",quantile=\"0.5\"} 225.3 "
            + scrapeTimestamp2s
            + "\n"
            + "http_request_duration_seconds{status=\"500\",quantile=\"0.9\"} 240.7 "
            + scrapeTimestamp2s
            + "\n"
            + "http_request_duration_seconds{status=\"500\",quantile=\"0.95\"} 245.1 "
            + scrapeTimestamp2s
            + "\n"
            + "http_request_duration_seconds_count{status=\"500\"} 7 "
            + scrapeTimestamp2s
            + "\n"
            + "http_request_duration_seconds_sum{status=\"500\"} 2.2 "
            + scrapeTimestamp2s
            + "\n"
            + "http_request_duration_seconds_created{status=\"500\"} "
            + createdTimestamp2s
            + " "
            + scrapeTimestamp2s
            + "\n"
                ...
                SummaryDataPointSnapshot.builder()
                    ...
                    .quantiles(
                        Quantiles.builder()
                            ...
                            .quantile(0.95, 245.1)
                            .build())
                    .labels(Labels.builder().label("status", "500").build())
                ...
                SummaryDataPointSnapshot.builder()
                    ...
                    .quantiles(
                        Quantiles.builder()
                            ...
                            .quantile(0.95, 245.1)
                            .build())
                    .labels(Labels.builder().label("status", "200").build())
  ...
  void testSummaryWithoutQuantiles() throws IOException {
    ...
    SummarySnapshot summary =
        SummarySnapshot.builder()
            ...
            .help("latency")
            .unit(Unit.SECONDS)
            .dataPoint(SummaryDataPointSnapshot.builder().count(3).sum(1.2).build())
            .build();
    assertOpenMetricsText(openMetricsText, summary);
    assertPrometheusText(prometheusText, summary);
  ...
  void testSummaryJustCount() throws IOException {
    ...
    SummarySnapshot summary =
        SummarySnapshot.builder()
            .name("latency_seconds")
            .dataPoint(SummaryDataPointSnapshot.builder().count(1).build())
            .build();
    assertOpenMetricsText(openMetricsText, summary);
    assertPrometheusText(prometheusText, summary);
    assertOpenMetricsTextWithoutCreated(openMetricsText, summary);
  ...
  void testSummaryJustSum() throws IOException {
    ...
    SummarySnapshot summary =
        SummarySnapshot.builder()
            .name("latency_seconds")
            .dataPoint(SummaryDataPointSnapshot.builder().sum(12.3).build())
            .build();
    assertOpenMetricsText(openMetricsText, summary);
    assertPrometheusText(prometheusText, summary);
    assertOpenMetricsTextWithoutCreated(openMetricsText, summary);
  ...
  void testSummaryEmptyAndNonEmpty() throws IOException {
    ...
    SummarySnapshot summary =
        SummarySnapshot.builder()
            .name("latency_seconds")
            .dataPoint(SummaryDataPointSnapshot.builder().labels(Labels.of("path", "/v1")).build())
            .dataPoint(
                SummaryDataPointSnapshot.builder()
                    ...
                    .sum(10.7)
                    .build())
            .dataPoint(SummaryDataPointSnapshot.builder().labels(Labels.of("path", "/v3")).build())
            .build();
    assertOpenMetricsText(openMetricsText, summary);
    assertPrometheusText(prometheusText, summary);
    assertOpenMetricsTextWithoutCreated(openMetricsText, summary);
  ...
  void testClassicHistogramComplete() throws Exception {
    String openMetricsText =
        "# TYPE response_size_bytes histogram\n"
            ...
            + exemplar1String
            + "\n"
            + "response_size_bytes_bucket{status=\"200\",le=\"+Inf\"} 3 "
            + scrapeTimestamp1s
            + " # "
            + exemplar2String
            + "\n"
            + "response_size_bytes_count{status=\"200\"} 3 "
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_sum{status=\"200\"} 4.1 "
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_created{status=\"200\"} "
            + createdTimestamp1s
            + " "
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_bucket{status=\"500\",le=\"1.0\"} 3 "
            + scrapeTimestamp2s
            + "\n"
            + "response_size_bytes_bucket{status=\"500\",le=\"2.2\"} 5 "
            + scrapeTimestamp2s
            + " # "
            + exemplar1String
            + "\n"
            + "response_size_bytes_bucket{status=\"500\",le=\"+Inf\"} 5 "
            + scrapeTimestamp2s
            + " # "
            + exemplar2String
            + "\n"
            + "response_size_bytes_count{status=\"500\"} 5 "
            + scrapeTimestamp2s
            + "\n"
            + "response_size_bytes_sum{status=\"500\"} 3.2 "
            + scrapeTimestamp2s
            + "\n"
            + "response_size_bytes_created{status=\"500\"} "
            + createdTimestamp2s
            + " "
            + scrapeTimestamp2s
            + "\n"
  ...
  @Test
  void testClassicHistogramMinimalWithDots() throws Exception {
    String openMetricsText =
        """
  ...
  void testClassicGaugeHistogramComplete() throws IOException {
    String openMetricsText =
        "# TYPE cache_size_bytes gaugehistogram\n"
            ...
            + "cache_size_bytes_bucket{db=\"items\",le=\"2.0\"} 3 "
            + scrapeTimestamp1s
            + " # "
            + exemplar1String
            + "\n"
            + "cache_size_bytes_bucket{db=\"items\",le=\"+Inf\"} 4 "
            + scrapeTimestamp1s
            + " # "
            + exemplar2String
            + "\n"
            + "cache_size_bytes_gcount{db=\"items\"} 4 "
            + scrapeTimestamp1s
            + "\n"
            + "cache_size_bytes_gsum{db=\"items\"} 17.0 "
            + scrapeTimestamp1s
            + "\n"
            + "cache_size_bytes_created{db=\"items\"} "
            + createdTimestamp1s
            + " "
            + scrapeTimestamp1s
            + "\n"
            + "cache_size_bytes_bucket{db=\"options\",le=\"2.0\"} 4 "
            + scrapeTimestamp2s
            + " # "
            + exemplar1String
            + "\n"
            + "cache_size_bytes_bucket{db=\"options\",le=\"+Inf\"} 4 "
            + scrapeTimestamp2s
            + " # "
            + exemplar2String
            + "\n"
            + "cache_size_bytes_gcount{db=\"options\"} 4 "
            + scrapeTimestamp2s
            + "\n"
            + "cache_size_bytes_gsum{db=\"options\"} 18.0 "
            + scrapeTimestamp2s
            + "\n"
            + "cache_size_bytes_created{db=\"options\"} "
            + createdTimestamp2s
            + " "
            + scrapeTimestamp2s
            + "\n"
    ...
    assertOpenMetricsTextWithExemplarsOnAllTimeSeries(
        openMetricsTextWithExemplarsOnAllTimeSeries, gaugeHistogram);
  ...
  void testClassicHistogramWithDots() throws IOException {
    ...
    String prometheusProtobuf =
        ...
        "name: \"my_request_duration_seconds\" "
            ...
            + "sample_count: 130 "
            + "sample_sum: 0.01 "
            + "bucket { cumulative_count: 130 upper_bound: Infinity "
            + exemplarWithDotsProtoString
            + " } "
            + "} "
            + "}";
  ...
  void testNativeHistogramComplete() throws IOException {
    String openMetricsText =
        "# TYPE response_size_bytes histogram\n"
            + "# UNIT response_size_bytes bytes\n"
            + "# HELP response_size_bytes help\n"
            + "response_size_bytes_bucket{status=\"200\",le=\"+Inf\"} 2 "
            + scrapeTimestamp1s
            + " # "
            + exemplar2String
            + "\n"
            + "response_size_bytes_count{status=\"200\"} 2 "
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_sum{status=\"200\"} 4.2 "
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_created{status=\"200\"} "
            + createdTimestamp1s
            ...
            + scrapeTimestamp1s
            + "\n"
            + "response_size_bytes_bucket{status=\"500\",le=\"+Inf\"} 55 "
            + scrapeTimestamp2s
            + " # "
            + exemplar2String
            + "\n"
            + "response_size_bytes_count{status=\"500\"} 55 "
            + scrapeTimestamp2s
            + "\n"
            + "response_size_bytes_sum{status=\"500\"} 3.2 "
            + scrapeTimestamp2s
        ...
        HistogramSnapshot.builder()
            ...
            .dataPoint(
                HistogramSnapshot.HistogramDataPointSnapshot.builder()
                    ...
                    .nativeSchema(5)
                    .nativeBucketsForPositiveValues(
                        NativeHistogramBuckets.builder().bucket(0, 2).build())
                    .labels(Labels.of("status", "200"))
                    .exemplars(Exemplars.of(exemplar1, exemplar2))
                    .createdTimestampMillis(createdTimestamp1)
                    .scrapeTimestampMillis(scrapeTimestamp1)
    ...
    assertOpenMetricsTextWithExemplarsOnAllTimeSeries(
        openMetricsTextWithExemplarsOnAllTimeSeries, nativeHistogram);
  ...
  void testNativeHistogramMinimal() throws IOException {
    ...
    HistogramSnapshot nativeHistogram =
        HistogramSnapshot.builder()
            .name("latency_seconds")
            .dataPoint(
                HistogramSnapshot.HistogramDataPointSnapshot.builder().nativeSchema(5).build())
            .build();
    assertOpenMetricsText(openMetricsText, nativeHistogram);
    assertPrometheusText(prometheusText, nativeHistogram);
    assertPrometheusProtobuf(prometheusProtobuf, nativeHistogram);
  ...
  void testNativeHistogramWithDots() throws IOException {
    ...
    String prometheusProtobuf =
        ...
        "name: \"my_request_duration_seconds\" "
            ...
            + "sample_count: 4 "
            + "sample_sum: 3.2 "
            + "bucket { cumulative_count: 4 upper_bound: Infinity "
            + exemplarWithDotsProtoString
            + " } "
            + "schema: 5 "
            + "zero_threshold: 0.0 "
  ...
  void testStateSetComplete() throws IOException {
    String openMetrics =
        "# TYPE state stateset\n"
            ...
            + "state{env=\"dev\",state=\"state1\"} 1 "
            + scrapeTimestamp1s
            + "\n"
            + "state{env=\"dev\",state=\"state2\"} 0 "
            + scrapeTimestamp1s
            + "\n"
            + "state{env=\"prod\",state=\"state1\"} 0 "
            + scrapeTimestamp2s
            + "\n"
  ...
  void testUnknownComplete() throws IOException {
    String openMetrics =
        "# TYPE my_special_thing_bytes unknown\n"
            ...
            + "my_special_thing_bytes{env=\"dev\"} 0.2 "
            + scrapeTimestamp1s
            + "\n"
  ...
  void testUnknownMinimal() throws IOException {
    ...
    UnknownSnapshot unknown =
        UnknownSnapshot.builder()
            .name("other")
            .dataPoint(UnknownDataPointSnapshot.builder().value(22.3).build())
            .build();
    assertOpenMetricsText(openMetrics, unknown);
    assertPrometheusText(prometheus, unknown);
    assertOpenMetricsTextWithoutCreated(openMetrics, unknown);
