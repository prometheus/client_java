  ...
  public DefaultHandler(String metricsPath) {
    ...
    String responseString =
        "<html>\n"
            ...
            + "<ul>\n"
            + String.format("<li><a href=\"%s?name[]=my_metric_a&name=my_metrics_b\">", metrics)
            ...
            + "The Prometheus server sends the <tt>Accept</tt> header "
            ...
            + "<tt>--enable-feature=native-histograms</tt>,\n"
            ...
            + "The Prometheus server uses the <tt>Accept</tt> "
