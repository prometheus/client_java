...
public class Exemplar {
  ...
  /**
   * To create a new {@link Exemplar}, you can either call the constructor directly or use the
   * Builder with {@link Exemplar#builder()}.
   *
   ...
   * @param timestampMillis timestamp when the value was observed. Optional. Use 0L if not
   *     available.
   */
  ...
  /**
   * In most cases labels will contain {@link #TRACE_ID} and {@link #SPAN_ID}, but this is not
   * required. May be {@link Labels#EMPTY}, but may not be {@code null}.
   */
