...
public final class InfoSnapshot extends MetricSnapshot {
   ...
   * builder with {@link InfoSnapshot#builder()}.
   *
   * @param metadata the metric name in metadata must not include the {@code _info} suffix. See
   *     {@link MetricMetadata} for more naming conventions. The metadata must not have a unit.
  ...
  public static class InfoDataPointSnapshot extends DataPointSnapshot {
    ...
    /**
     * To create a new {@link InfoDataPointSnapshot}, you can either call the constructor directly
     * or use the Builder with {@link InfoDataPointSnapshot#builder()}.
     *
